...
Public Class WebCam
    ...
    Dim Ancho As Integer = 188
    Dim Alto As Integer = 165
...
#End Region
    ...
    Public Function Capturar(ByVal picture As PictureBox, ByVal nombre As String) As String
        Dim direccion As String = My.Application.Info.DirectoryPath + "\Imagenes\"
        BuscaCarpeta(direccion)
        Dim sfile_JPG As String = direccion + nombre + ".jpg"
    ...
    Private Sub BuscaCarpeta(ByVal direccion As String)
        '  Dim logDirectoryProperties As System.IO.DirectoryInfo
        If My.Computer.FileSystem.DirectoryExists(direccion) = False Then
