Public Class dbServiciosClasificaciones
    ...
    Public Sub Guardar(ByVal pNombre As String)
        Nombre = pNombre
        Comm.CommandText = "insert into tblserviciosclasificaciones(nombre) values('" + Replace(Nombre, "'", "''") + "')"
        Comm.ExecuteNonQuery()
    End Sub
    Public Sub Modificar(ByVal pID As Integer, ByVal pNombre As String)
        ID = pID
        Nombre = pNombre
        Comm.CommandText = "update tblserviciosclasificaciones set nombre='" + Replace(Nombre, "'", "''") + "' where idclasificacion=" + ID.ToString
        Comm.ExecuteNonQuery()
    End Sub
