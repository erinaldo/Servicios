Public Class dbDetallesEquipo
    ...
    Public Sub Guardar(ByVal pIdEquipo As Integer, ByVal pCantidad As Double, ByVal pIdInventariop As Integer, ByVal pVida As String, ByVal pFecha As String)
        Comm.CommandText = "insert into tbldetallesequipos(idEquipo,Cantidad,idInventario,TiempoVida,fecha) values(" + pIdEquipo.ToString + "," + pCantidad.ToString + "," + pIdInventariop.ToString + "," + pVida.ToString + ",'" + pFecha.ToString + "')"
    ...
    Public Sub GuardarSucursal(ByVal pIdEquipo As Integer, ByVal pCantidad As Double, ByVal pIdInventariop As Integer, ByVal pVida As String, ByVal pFecha As String)
        Comm.CommandText = "insert into tbldetallesequiposs(idEquipo,Cantidad,idInventario,TiempoVida,fecha) values(" + pIdEquipo.ToString + "," + pCantidad.ToString + "," + pIdInventariop.ToString + "," + pVida.ToString + ",'" + pFecha.ToString + "')"
        Comm.ExecuteNonQuery()
    End Sub
    ...
    Public Sub Modificar(ByVal pID As Integer, ByVal pCantidad As Double, ByVal pIdInventariop As Integer, ByVal pVida As String)
        ...
        Comm.CommandText = "update tbldetallesequipos set Cantidad='" + pCantidad.ToString + "', idInventario='" + pIdInventariop.ToString() + "', TiempoVida='" + pVida.ToString() + "' where idDetalles=" + pID.ToString
        Comm.ExecuteNonQuery()
    End Sub
    Public Sub ModificarSucursal(ByVal pID As Integer, ByVal pCantidad As Double, ByVal pIdInventariop As Integer, ByVal pVida As String)
        ...
        Comm.CommandText = "update tbldetallesequiposs set Cantidad='" + pCantidad.ToString + "', idInventario='" + pIdInventariop.ToString() + "', TiempoVida='" + pVida.ToString() + "' where idDetalle=" + pID.ToString
        Comm.ExecuteNonQuery()
    End Sub
    ...
    Public Sub clienteDatos(ByVal pidCliente As Integer)
        Dim DReader As MySql.Data.MySqlClient.MySqlDataReader
        Comm.CommandText = "select nombre,rfc,direccion,noexterior,colonia,ciudad,estado,pais from tblcliente where idcliente=" + pidCliente.ToString()
        DReader = Comm.ExecuteReader
        If DReader.Read() Then
