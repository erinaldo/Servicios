...
Public Class dbIdentificacion
    ...
    Public Sub Guardar(ByVal pNombre As String)
        Comm.CommandText = "insert into tblidentificacion (nombre) values('" + pNombre + "');"
        Comm.ExecuteNonQuery()

    End Sub
    Public Sub LlenaDatos(ByVal pId As Integer)
        Dim DR As MySql.Data.MySqlClient.MySqlDataReader
        Comm.CommandText = "select * from tblidentificacion where ididentificacion=" + pId.ToString
    ...
    Public Sub Modificar(ByVal pId As Integer, ByVal pNombre As String)
        'Modifica
        Comm.CommandText = "update tblidentificacion set nombre='" + pNombre + "'  where idIdentificacion=" + pId.ToString()
        Comm.ExecuteNonQuery()
    End Sub

    Public Function filtroClasificacion(ByVal pNombre As String) As DataTable
        Dim DS As New DataSet
        Comm.CommandText = "select * from tblidentificacion  where nombre LIKE '%" + pNombre.ToString() + "%' "
