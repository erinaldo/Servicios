Public Class dbClientesImpuestos
    ...
    Public Sub Guardar(ByVal pNombre As String, ByVal pTipo As Byte, ByVal pTasa As Double, ByVal pIdcliente As Integer)
        Comm.CommandText = "insert into tblclientesimpuestos(idcliente,tipo,tasa,nombre) values(" + pIdcliente.ToString + "," + pTipo.ToString + "," + pTasa.ToString + ",'" + Replace(pNombre, "'", "''") + "')"
        Comm.ExecuteNonQuery()
    End Sub
    Public Sub Modificar(ByVal pID As Integer, ByVal pNombre As String, ByVal pTipo As Byte, ByVal pTasa As Double)
        ID = pID
        Comm.CommandText = "update tblclientesimpuestos set nombre='" + Replace(pNombre, "'", "''") + "',tipo=" + pTipo.ToString + ",tasa=" + pTasa.ToString + " where idimpuesto=" + ID.ToString
        Comm.ExecuteNonQuery()
    End Sub
