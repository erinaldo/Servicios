Public Class dbventasaduana
    ...
    Public Function ConsultaTodoReader(ByVal pidVenta As Integer) As MySql.Data.MySqlClient.MySqlDataReader
        Comm.CommandText = "select tblventasaduana.idaduana,tblventasaduana.numero,tblventasaduana.fecha,tblventasaduana.aduana,tblventasaduana.iddetalle from tblventasaduana inner join tblventasinventario on tblventasaduana.iddetalle=tblventasinventario.idventasinventario where tblventasinventario.idventa=" + pidVenta.ToString
        Return Comm.ExecuteReader
    End Function
