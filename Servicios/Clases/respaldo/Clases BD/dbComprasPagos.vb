Public Class dbComprasPagos
    ...
    Public Sub Modificar(ByVal pID As Integer, ByVal pCantidad As Double, ByVal pFecha As String, ByVal pTipo As String, ByVal pIdCliente As Integer)
        ...
        Comm.CommandTimeout = 200
        Comm.Transaction = Comm.Connection.BeginTransaction
        Comm.CommandText = "update tblcompraspagos set cantidad=" + Cantidad.ToString + ",fecha='" + Fecha + "',tipo='" + Replace(Tipo, "'", "''") + "' where idpago=" + ID.ToString
        Comm.ExecuteNonQuery()
    ...
    '    Return DS.Tables("tblcompraspagos").DefaultView
    'End Function
    Public Function Reporte(ByVal pFecha1 As String, ByVal pFecha2 As String, ByVal pIdProveedor As Integer, ByVal pIdMoneda As Integer, ByVal pMostrasEnPesos As Byte, ByVal pIdConcepto As Integer, ByVal pConContado As Boolean) As DataView
        Dim DS As New DataSet
