Public Class dbInventarioPrecios
    ...
    End Sub
    Public Sub Modificar(ByVal pID As Integer, ByVal pPrecio As Double, ByVal pUtilidad As Byte, ByVal pComentario As String, ByVal pIdMoneda As Integer, ByVal pDescuento As Integer)
        ID = pID
        Precio = pPrecio
        utilidad = pUtilidad
        Comentario = pComentario
    ...
    Public Function Reporte(ByVal pIdInventario As Integer, ByVal pIdClas1 As Integer, ByVal pIDClas2 As Integer, ByVal pIDclas3 As Integer) As DataView
        ...
        " from tblinventario as i  where i.idinventario>1 "
