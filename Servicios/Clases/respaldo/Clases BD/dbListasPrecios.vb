Public Class dbListasPrecios
    ...
    Public Sub Modificar(ByVal pID As Integer, ByVal pDescripcion As String, ByVal pNumero As String)
        ...
        Descripcion = pDescripcion
        Numero = pNumero
        Comm.CommandText = "update tbllistasprecios set descripcion='" + Replace(pDescripcion, "'", "''") + "',numero='" + Replace(Numero, "'", "''") + "', idUsuarioCambio=" + GlobalIdUsuario.ToString() + ",  fechaCambio='" + DateTime.Now.ToString("yyyy/MM/dd") + "', horaCambio='" + TimeOfDay + "' where idlista=" + ID.ToString
        Comm.ExecuteNonQuery()
    End Sub
