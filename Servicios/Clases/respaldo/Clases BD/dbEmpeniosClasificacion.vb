...
Public Class dbEmpeniosClasificacion
    ...
    Public Sub Guardar(ByVal pNombre As String)
        Comm.CommandText = "insert into tblempeniosclasificacion (nombre) values('" + Replace(pNombre, "'", "''") + "');"
    ...
    Public Sub Modificar(ByVal pId As Integer, ByVal pNombre As String)
        'Modifica
        Comm.CommandText = "update tblempeniosclasificacion set nombre='" + Replace(pNombre, "'", "''") + "'  where idClasificacion=" + pId.ToString()
        Comm.ExecuteNonQuery()
    End Sub

    Public Function filtroClasificacion(ByVal pNombre As String) As DataTable
        Dim DS As New DataSet
        Comm.CommandText = "select * from tblempeniosclasificacion  where nombre LIKE '%" + pNombre.ToString() + "%' "
