...
Public Class dbCContables
    ...
    Public Function FolioNuevo() As String
    ...
    Public Sub Guardar(ByVal pCodigo As String, ByVal pNombre As String, ByVal pTipo As String, ByVal pNaturaleza As String)
        ...
        Comm.CommandText = "insert into tblccontables (Cuenta,Descripcion,Nivel,Tipo,Naturaleza) values('" + Replace(C1, "'", "''") + "','" + Replace(D1, "'", "''") + "','" + Replace(nivel, "'", "''") + "','" + Replace(pTipo, "'", "''") + "','" + Replace(pNaturaleza, "'", "''") + "')"
        Comm.ExecuteNonQuery()
        CuentaComple(1, C1)
    ...
    Public Sub Modificar(ByVal pCodigo As String, ByVal pNombre As String, ByVal pTipo As String, ByVal pNaturaleza As String)
        ...
        C1 = pCodigo
        D1 = pNombre
        Comm.CommandText = "update tblccontables set Cuenta='" + Replace(C1, "'", "''") + "',Descripcion='" + Replace(D1, "'", "''") + "',Tipo='" + Replace(pTipo, "'", "''") + "', Naturaleza='" + Replace(pNaturaleza, "'", "''") + "' where Cuenta='" + C1 + "' AND Nivel='1'"
        Comm.ExecuteNonQuery()
        CuentaComple(1, C1)
    End Sub
