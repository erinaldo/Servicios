Public Class dbVentasPagosRemisiones
    ...
    Public Sub Guardar(ByVal pIdRemision As Integer, ByVal pCantidad As Double, ByVal pFecha As String, ByVal pidCliente As Integer, ByVal ppTipodeCambio As Double, ByVal pIdMoneda As Integer, ByVal pIdConceptoNotaVenta As Integer, ByVal pTipo As String, ByVal pIdDevolucion As Integer)
        ...
        Comm.CommandText = "insert into tblventaspagosremisiones(idremision,cantidad,estado,fecha,hora,fechacancelado,horacancelado,idcliente,idmoneda,ptipodecambio,idconceptonotaventa,tipo,iddevolucion) values(" + IdRemision.ToString + "," + Cantidad.ToString + ",3,'" + Fecha + "','" + Format(TimeOfDay, "HH:mm:ss") + "','" + Format(Date.Now, "yyyy/MM/dd") + "','" + Format(TimeOfDay, "HH:mm:ss") + "'," + IdCliente.ToString + "," + idMoneda.ToString + "," + pTipodeCambio.ToString + "," + Idconceptonotaventa.ToString + ",'" + Replace(Tipo, "'", "''") + "'," + IdDevolucion.ToString + ")"
    ...
    Public Function Consulta(ByVal pIdremision As Integer) As DataView
        ...
        Comm.CommandText = "select  idpago,fecha,cantidad,tblventaspagosremisiones.tipo,tblconceptosnotasventas.nombre from tblventaspagosremisiones inner join tblconceptosnotasventas on tblventaspagosremisiones.idconceptonotaventa=tblconceptosnotasventas.idconceptonotaventa where estado=3 and idremision=" + pIdremision.ToString
