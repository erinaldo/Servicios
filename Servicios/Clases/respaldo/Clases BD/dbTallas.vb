Public Class dbTallas
    ...
    Public Sub Guardar(ByVal pNombre As String, ByVal pDireccion As String, ByVal pComentario As String)
        ...
        Comm.CommandText = "insert into tbltallas(nombre,codigo,comentario) values('" + Replace(Nombre, "'", "''") + "','" + Replace(Codigo, "'", "''") + "','" + Replace(Comentario, "'", "''") + "')"
    ...
    Public Sub Modificar(ByVal pID As Integer, ByVal pNombre As String, ByVal pDireccion As String, ByVal pComentario As String)
        ...
        Codigo = pDireccion
        Comentario = pComentario
        Comm.CommandText = "update tbltallas set nombre='" + Replace(Nombre, "'", "''") + "',codigo='" + Replace(Codigo, "'", "''") + "',comentario='" + Replace(Comentario, "'", "''") + "' where idtalla=" + ID.ToString
        Comm.ExecuteNonQuery()
    End Sub
