...
Public Class dbContabilidadPolizas
    ...
    Dim DetalleIdPoliza As Integer
    Dim Detallecuenta As String
    Dim Detalledescripcion As String
    Dim Detallecargo As Double
    Dim DetalleAbono As Double
    Dim DetalleidCuenta As Integer
    Dim Detallefactura As String
    Dim Detalleidproveedor As Integer
    Dim Detalleiva As String
    Dim Detalleconcepto As String
    Dim DetalleesDIOT As Byte
    Dim DetalleDIOTHabilitado As Byte
    Dim DetallefechaDiot As String
    Dim DetallevalorActos As String
    Dim Detallereferencia As String
    Dim Detalleivaret As Double
    Dim Detalleieps As Double
    ...
    End Sub
    Public Function bucarNumero(ByVal pMes As String, ByVal pAnio As String, ByVal ptipo As String) As Integer
        Dim contador As Integer = 0
        Dim numero As Integer = 0

        Comm.CommandText = "select count(id) from tblpolizas where tipo='" + ptipo + "' and  fecha>='" + pAnio + "/" + pMes + "/01' and fecha<='" + pAnio + "/" + pMes + "/31' "
        contador = Comm.ExecuteScalar
        If contador > 0 Then
            Comm.CommandText = "select max(numero) from tblpolizas where fecha>='" + pAnio + "/" + pMes + "/01' and fecha<='" + pAnio + "/" + pMes + "/31' and tipo='" + ptipo + "'"
        ...
        Return numero
    End Function
    Public Function folioRepetido(ByVal pMes As String, ByVal pAnio As String, ByVal ptipo As String, ByVal pNumero As Integer) As Integer
        Dim contador As Integer = 0
        Dim numero As Integer = 0
        Comm.CommandText = "select count(id) from tblpolizas where tipo='" + ptipo + "' and numero=" + pNumero.ToString + " and  fecha>='" + pAnio + "/" + pMes + "/01' and fecha<='" + pAnio + "/" + pMes + "/31' "
        contador = Comm.ExecuteScalar
        Return contador
    End Function
    ...
    Public Sub guardarPoliza(ByVal ptipo As String, ByVal pNumer As Integer, ByVal pFecha As String, ByVal pConcepto As String, ByVal pBeneficiario As String, ByVal pImporte As String, ByVal pClas As Integer)
        Comm.CommandText = "insert into tblpolizas (tipo,numero,fecha,concepto,beneficiario,importe,clasificacion) values('" + ptipo.ToString + "'," + pNumer.ToString + ",'" + pFecha + "','" + Replace(pConcepto, "'", "''") + "','" + Replace(pBeneficiario, "'", "''") + "','" + pImporte.ToString + "'," + pClas.ToString + ")"
        Comm.ExecuteNonQuery()
        Comm.CommandText = " select max(id) from tblpolizas"
        IDPoliza = Comm.ExecuteScalar

    End Sub
    Public Sub ActualizaMontoPoliza(pidPoliza As Integer)
    ...
    Public Sub guardarCheque(ByVal pIDPoliza As Integer, ByVal pRenglon As Integer, ByVal pNumero As String, ByVal pBanco As Integer, ByVal pBancoEx As String, ByVal pCtaOri As String, ByVal pFecha As String, ByVal pBeneficiario As String, ByVal pRFC As String, ByVal pMonto As Double, ByVal pIDMoneda As Integer, ByVal pTipoCambio As Double)
        ...
        Comm.ExecuteNonQuery()
    End Sub
    Public Sub EliminarCheque(ByVal pIDPoliza As Integer)
        Comm.CommandText = " delete from tblcontabilidadCheque where idPoliza=" + pIDPoliza.ToString + ";"
        Comm.ExecuteNonQuery()
    End Sub
    Public Sub guardarTransaccion(ByVal pIdPoliza As Integer, ByVal pIdRenglon As Integer, ByVal pCtaOri As String, ByVal pBancoOri As Integer, ByVal pBancoExO As String, ByVal pCtaDEst As String, ByVal pBancoDest As Integer, ByVal pBancoExD As String, ByVal pFecha As String, ByVal pBenef As String, ByVal pRFC As String, ByVal pMonto As Double, ByVal pidMoneda As Integer, ByVal pTipoCambio As Double)
        ...
        Comm.ExecuteNonQuery()
    End Sub
    Public Sub EliminarTrans(ByVal pIDPoliza As Integer)
        Comm.CommandText = " delete from tblcontabilidadTrans where idPoliza=" + pIDPoliza.ToString + ";"
        Comm.ExecuteNonQuery()
    End Sub
    Public Sub guardarComprobante(ByVal pIDPoliza As Integer, ByVal pIDRenglon As Integer, ByVal pUUID As String, ByVal pMonto As Double, ByVal pRFC As String, ByVal pidMoneda As Integer, ByVal pTipoCambio As Double)
        ...
        Comm.ExecuteNonQuery()
    End Sub
    Public Sub EliminarCompro(ByVal pIDPoliza As Integer)
        Comm.CommandText = " delete from tblcontabilidadCompro where idPoliza=" + pIDPoliza.ToString + ";"
        Comm.ExecuteNonQuery()
    End Sub
    Public Sub guardarComprobanteNac2(ByVal pIDPoliza As Integer, ByVal pIDRenglon As Integer, ByVal pSerie As String, ByVal pFolio As Integer, ByVal pRFC As String, ByVal pmonto As Double, ByVal pidMoneda As Integer, ByVal pTipoCambio As Double)
        ...
        Comm.ExecuteNonQuery()
    End Sub
    Public Sub EliminarComproNac2(ByVal pIDPoliza As Integer)
        Comm.CommandText = " delete from tblcontabilidadcompro2 where idPoliza=" + pIDPoliza.ToString + ";"
        Comm.ExecuteNonQuery()
    End Sub
    ...
    Public Sub guardarComprobanteE(ByVal pIDPoliza As Integer, ByVal pIDRenglon As Integer, ByVal pNumerdoFactura As String, ByVal ptaxID As String, ByVal pmonto As Double, ByVal pidMoneda As Integer, ByVal pTipoCambio As Double)
        ...
        Comm.ExecuteNonQuery()
    End Sub
    Public Sub EliminarComproE(ByVal pIDPoliza As Integer)
        Comm.CommandText = " delete from tblcontabilidadcomproe where idPoliza=" + pIDPoliza.ToString + ";"
        Comm.ExecuteNonQuery()
    End Sub
    Public Sub guardarOtro(ByVal pIDPoliza As Integer, ByVal pIDRenglon As Integer, ByVal pMetodoPago As Integer, ByVal pFecha As String, ByVal pBeneficiario As String, ByVal pRFC As String, ByVal pmonto As Double, ByVal pidMoneda As Integer, ByVal pTipoCambio As Double)
        ...
        Comm.ExecuteNonQuery()
    End Sub
    Public Sub EliminarOtro(ByVal pIDPoliza As Integer)
        Comm.CommandText = " delete from tblcontabilidadotros where idPoliza=" + pIDPoliza.ToString + ";"
        Comm.ExecuteNonQuery()
    End Sub

    Public Function reporte(ByVal pFechaI As String, ByVal pFechaF As String, ByVal pCon As String, ByVal ptipo As Integer, ByVal pClasif As Integer) As DataView
        Dim DS As New DataSet
        Comm.CommandText = "select tblpolizas.id,Concat(tblpolizas.tipo,tblpolizas.numero) as Póliza,tblpolizas.fecha as Fecha,tblpolizas.concepto as Concepto,tblpolizas.importe as Importe,(select (ifnull(sum(if(tblpolizasdetalles.cargo=-999999999,0,tblpolizasdetalles.cargo)),0)-ifnull(sum(if(tblpolizasdetalles.abono=-999999999,0,tblpolizasdetalles.abono)),0)) from tblpolizasdetalles where  tblpolizasdetalles.idPoliza=tblPolizas.id) as dif,tblcontabilidadclas.nombre as Clasificacion from tblpolizas inner join tblcontabilidadclas on tblcontabilidadclas.id=tblPolizas.clasificacion  where fecha>='" + pFechaI + "' and fecha<='" + pFechaF + "' "
        If pCon <> "" Then
        ...
        If ptipo <> 0 Then
            ...
            End If
        End If
        Comm.CommandText += " order by tipo,numero"
    ...
    Public Function llenaDatosPoliza(ByVal pID As Integer)
        ...
        Dim DS As New DataSet
        Comm.CommandText = "select id,idCuenta,cuenta as Cuenta,descripcion,if(cargo=-999999999,'',cargo)as cargo,if(abono=-999999999,'',abono)as abono,factura,idproveedor,iva,concepto,esDIOT,valorActos,referencia,ivaret,ieps from tblpolizasdetalles where idPoliza=" + IDPoliza.ToString
        Dim DA As New MySql.Data.MySqlClient.MySqlDataAdapter(Comm)
        DA.Fill(DS, "tblpoliza")
        'DS.WriteXmlSchema("tblalmacenes.xml")
    ...
    Public Sub modificarPoliza(ByVal pID As Integer, ByVal ptipo As String, ByVal pNumer As Integer, ByVal pFecha As String, ByVal pConcepto As String, ByVal pBeneficiario As String, ByVal pImporte As String, ByVal pClas As Integer)
        IDPoliza = pID
        Comm.CommandText = "update tblpolizas set tipo='" + ptipo + "',numero=" + pNumer.ToString + ",fecha='" + pFecha + "',concepto='" + Replace(pConcepto, "'", "''") + "',beneficiario='" + Replace(pBeneficiario, "'", "''") + "',importe='" + pImporte.ToString + "', clasificacion=" + pClas.ToString + " where id=" + pID.ToString
        Comm.ExecuteNonQuery()
  ...
  "ifnull((select saldoI from tblcontabilidadsaldosi where concat(tblcontabilidadsaldosi.Cuenta,tblcontabilidadsaldosi.N1)=(select concat(Cuenta,N2) from tblccontables where idCContable=tblpolizasdetalles.idCuenta) limit 1),0) as saldoInicial," + _
  "if(tblpolizas.tipo<>'A' and tblpolizas.fecha>='" + pfechaInicial + "',ifnull(if(tblpolizasdetalles.cargo=-999999999,0,tblpolizasdetalles.cargo),0),0) as cargo," + _
  "if(tblpolizas.tipo<>'A' and tblpolizas.fecha>='" + pfechaInicial + "',ifnull(if(tblpolizasdetalles.abono=-999999999,0,tblpolizasdetalles.abono),0),0) as abono," + _
  "tblccontables.cuenta as cuenta1," + _
  "tblccontables.N2 as cuenta2," + _
  "tblccontables.descripcion as descripcionMAyor," + _
  "'' as agruMayor," + _
  "if(tblccontables.nivel=1,(select sum(saldoI) from tblcontabilidadsaldosi where Cuenta=tblccontables.Cuenta),0)  as SaldoInicMayor," + _
  "if(tblccontables.nivel=1,(select ifnull(sum(if(d.cargo=-999999999,0,d.cargo)),0) from tblpolizasdetalles as d inner join tblccontables as dd on d.idCuenta=dd.idCContable inner join tblpolizas as pp on d.idPoliza=pp.id  where dd.Cuenta=tblccontables.cuenta and pp.tipo<>'A' and pp.fecha<='" + pFechaFinal + "' and pp.fecha>='" + pfechaInicial + "'),0) as saldoCMay," + _
  "if(tblccontables.nivel=1,(select ifnull(sum(if(d.abono=-999999999,0,d.abono)),0) from tblpolizasdetalles as d inner join tblccontables as dd on d.idCuenta=dd.idCContable inner join tblpolizas as pp on d.idPoliza=pp.id  where dd.Cuenta=tblccontables.cuenta and pp.tipo<>'A' and pp.fecha<='" + pFechaFinal + "' and pp.fecha>='" + pfechaInicial + "'),0) as saldoAMay" + _
  " from tblpolizasdetalles inner join tblPolizas on tblpolizasdetalles.idPoliza=tblPolizas.id and tblPolizas.fecha>='" + anio + "/01/01' and tblPolizas.fecha<='" + pFechaFinal + "' and tblpolizas.tipo<>'O' right outer join tblccontables inner join tblagrupadorcuentas on tblccontables.idcontable=tblagrupadorcuentas.id  on tblpolizasdetalles.idcuenta=tblccontables.idccontable order by Cuenta;"
    ...
    End Function
    Public Function reporteBalanzaXML2(ByVal pMes As String)
        Dim DS2 As New DataSet
        Dim pHasta As Date = Date.Parse("01/" + pMes + "/" + anio)
    ...
    Public Sub SaldosIniciales(ByVal pHasta As String, ByVal pMes As String)
        ...
        Comm.ExecuteNonQuery()
        Comm.CommandText = "insert into tblcontabilidadsaldosi(idCContable,Cuenta,N1,naturaleza,saldoI) select tblccontables.idccontable,tblccontables.Cuenta,tblccontables.N2,tblccontables.Naturaleza,ifnull(sum(if(cargo=-999999999,0,cargo)),0)-ifnull(sum(if(abono=-999999999,0,abono)),0) from tblpolizasdetalles inner join tblPolizas on tblpolizasdetalles.idPoliza=tblPolizas.id"
        If pMes = "01" Then
        ...
        Comm.CommandText += "insert into tblcontabilidadsaldosi(idCContable,Cuenta,N1,naturaleza,saldoI) select tblccontables.idccontable,tblccontables.Cuenta,tblccontables.N2,tblccontables.Naturaleza,ifnull(sum(if(abono=-999999999,0,abono)),0)-ifnull(sum(if(cargo=-999999999,0,cargo)),0) from tblpolizasdetalles inner join tblPolizas on tblpolizasdetalles.idPoliza=tblPolizas.id"
        If pMes = "01" Then
            Comm.CommandText += " and tblPolizas.fecha>='" + anio + "/01/01' and tblPolizas.fecha<='" + anio.ToString + "/12/31' and tblPolizas.tipo='A'"
        Else
            Comm.CommandText += " and tblPolizas.fecha>='" + anio + "/01/01' and tblPolizas.fecha<'" + pHasta + "'"
...
"round(sum(if(tblpolizas.tipo<>'A' and tblpolizas.fecha>='" + pFechaI + "',ifnull(if(tblpolizasdetalles.cargo=-999999999,0,tblpolizasdetalles.cargo),0),0)),2) as cargo," + _
"round(sum(if(tblpolizas.tipo<>'A' and tblpolizas.fecha>='" + pFechaI + "',ifnull(if(tblpolizasdetalles.abono=-999999999,0,tblpolizasdetalles.abono),0),0)),2) as abono," + _
"tblccontables.cuenta as cuenta1," + _
...
"tblccontables.descripcion as descripcionMAyor," + _
"'' as agruMayor," + _
"round(if(tblccontables.nivel=1,(select sum(saldoI) from tblcontabilidadsaldosi where Cuenta=tblccontables.Cuenta),0),2)  as SaldoInicMayor," + _
"round(if(tblccontables.nivel=1,(select ifnull(sum(if(d.cargo=-999999999,0,d.cargo)),0) from tblpolizasdetalles as d inner join tblccontables as dd on d.idCuenta=dd.idCContable inner join tblpolizas as pp on d.idPoliza=pp.id  where dd.Cuenta=tblccontables.cuenta and pp.tipo<>'A' and pp.fecha<='" + pFechaF + "' and pp.fecha>='" + pFechaI + "'),0),2) as saldoCMay," + _
"round(if(tblccontables.nivel=1,(select ifnull(sum(if(d.abono=-999999999,0,d.abono)),0) from tblpolizasdetalles as d inner join tblccontables as dd on d.idCuenta=dd.idCContable inner join tblpolizas as pp on d.idPoliza=pp.id  where dd.Cuenta=tblccontables.cuenta and pp.tipo<>'A' and pp.fecha<='" + pFechaF + "' and pp.fecha>='" + pFechaI + "'),0),2) as saldoAMay" + _
" from tblpolizasdetalles inner join tblPolizas on tblpolizasdetalles.idPoliza=tblPolizas.id and tblPolizas.fecha<='" + pFechaF + "' and tblPolizas.fecha>='" + anio + "/01/01' and tblpolizas.tipo<>'O' inner join tblccontables on tblpolizasdetalles.idcuenta=tblccontables.idccontable " + _
"inner join tblagrupadorcuentas on tblccontables.idcontable=tblagrupadorcuentas.id "
    ...
    Public Function impresionPolizasE(ByVal pFechaInicio As String, ByVal pFechaFinal As String, ByVal pTipo As String, ByVal pRangoDesde As Integer, ByVal pRangoHasta As Integer, Optional ByVal pIDCuenta As Integer = -1, Optional ByVal pClasif As Integer = -1)
        Dim DS2 As New DataSet
        Comm.CommandText = "Select tblpolizas.id as id, tblpolizas.concepto as concepto, if(tblCContables.nivel>=1,LPAD(tblccontables.Cuenta," + NNiv1.ToString + ",'0'),'') as N1,if(tblCContables.nivel>=2,LPAD(tblccontables.N2," + NNiv2.ToString + ",'0'),'') as N2,if(tblCContables.N3>=3,LPAD(tblccontables.N3," + NNiv3.ToString + ",'0'),'') as N3,if(tblCContables.N3>=4,LPAD(tblccontables.N4," + NNiv4.ToString + ",'0'),'') as N4,if(tblCContables.N5>=5,LPAD(tblccontables.N5," + NNiv5.ToString + ",'0'),'') as N5, if(tblCContables.nivel>=1,(select cc.descripcion from tblccontables as cc where cc.Cuenta=tblCContables.Cuenta and cc.nivel=1),'')as D1,if(tblCContables.nivel>=2,(select cc.descripcion from tblccontables as cc where cc.Cuenta=tblCContables.Cuenta and cc.N2=tblCContables.N2 and cc.nivel=2),'')as D2,if(tblCContables.nivel>=3,(select cc.descripcion from tblccontables as cc where cc.Cuenta=tblCContables.Cuenta and cc.N2=tblCContables.N2 and cc.N3=tblCContables.N3 and cc.nivel=3),'')as D3,if(tblCContables.nivel>=4,(select cc.descripcion from tblccontables as cc where cc.Cuenta=tblCContables.Cuenta and cc.N2=tblCContables.N2 and cc.N3=tblCContables.N3 and  cc.N4=tblCContables.N4 and cc.nivel=4),'')as D4,if(tblCContables.nivel>=5,(select cc.descripcion from tblccontables as cc where cc.Cuenta=tblCContables.Cuenta and cc.N2=tblCContables.N2 and cc.N3=tblCContables.N3 and  cc.N4=tblCContables.N4 and  cc.N5=tblCContables.N5 and cc.nivel=5),'')as D5, tblpolizasdetalles.descripcion, concat(tblPolizas.tipo,' ',tblPolizas.numero) as tipo, tblpolizas.importe as numero, DATE_FORMAT(tblpolizas.fecha, '%d - %m - %Y') as fecha, if(tblpolizasdetalles.cargo=-999999999,0,tblpolizasdetalles.cargo) as cargo, if(tblpolizasdetalles.abono=-999999999,0,tblpolizasdetalles.abono)as abono, tblPolizas.beneficiario from tblpolizasdetalles inner join tblPolizas on tblpolizasdetalles.idPoliza=tblPolizas.id inner join tblCContables on tblpolizasdetalles.idCuenta=tblCContables.idCContable where tblPolizas.fecha>='" + pFechaInicio + "' and tblPolizas.fecha<='" + pFechaFinal + "' "
        ' If pTipo <> "T" Then
        'Comm.CommandText += " and tblPolizas.tipo='" + pTipo + "'"
        ' Else
    ...
    Public Function polizaCierre()
        ...
        SaldosIniciales((anio + 1).ToString + "/01/01", 12)
        Comm.CommandText = "Select  detalles.idCuenta as IdCuenta ,(select concat(LPAD(tblccontables.Cuenta," + NNiv1.ToString + ",'0'),' ',if(tblccontables.N2<>'',LPAD(tblccontables.N2," + NNiv2.ToString + ",'0'),'')) from tblccontables where idCContable=detalles.idCuenta) as Cuenta"
        Comm.CommandText += " ,(select if(tblccontables.Naturaleza=0,'D','A') from tblccontables where tblccontables.idCContable=detalles.idCuenta) as Naturaleza "
        Comm.CommandText += ",ifnull((select ifnull(saldoI,0) from tblcontabilidadsaldosi where concat(tblcontabilidadsaldosi.Cuenta,tblcontabilidadsaldosi.N1)=(select concat(Cuenta,N2) from tblccontables where idCContable=detalles.idCuenta) limit 1),0) as saldoInicial"
        ' Comm.CommandText += ")"
        ...
        Comm.CommandText += " where  poliza.tipo<>'O'  and poliza.fecha<='" + anio + "/12/31' and poliza.fecha>='" + anio + "/01/01'"
        Comm.CommandText += "and ((cc.Cuenta>=" + activoC1 + " and cc.Cuenta<=" + activoC2 + ") or (cc.Cuenta>=" + activoF1 + " and cc.Cuenta<=" + activoF2 + ") or (cc.Cuenta>=" + activoD1 + " and cc.Cuenta<=" + activoD2 + ") or (cc.Cuenta>=" + activoO1 + " and cc.Cuenta<=" + activoO2 + ") or (cc.Cuenta>=" + capital1 + " and cc.Cuenta<=" + capital1 + ") or (cc.Cuenta>=" + pasivoC1 + " and cc.Cuenta<=" + pasivoC2 + ") or (cc.Cuenta>=" + pasivoF1 + " and cc.Cuenta<=" + pasivoF2 + ") or (cc.Cuenta>=" + pasivoD1 + " and cc.Cuenta<=" + pasivoD2 + "))"
    ...
    Public Sub llenadoTablasMes(ByVal fechaI As String, ByVal pFechaF As String, ByVal pidCContable As Integer, ByVal pNivel As Integer)
        ...
        Comm.ExecuteNonQuery()
    End Sub
    Public Function consultaSaldosMes(ByVal pIDC As Integer, ByVal pNivel As Integer) As DataView
        Dim DS2 As New DataSet
        Dim DA2 As New MySql.Data.MySqlClient.MySqlDataAdapter(Comm)
    ...
    Public Function Sumaactivo(ByVal pFechaHasta As String)
        Dim saldo As Double
        ...
        Return saldo
    End Function
    Public Function Sumaapasivo(ByVal pFechaHasta As String)
        Dim saldo As Double
        Comm.CommandText = "delete from tblSaldos;"
    ...
    Public Function Sumacapital(ByVal pFechaHasta As String)
        ...
        Return saldo
    End Function
    Public Function activo(ByVal pFechaHasta As String)
        'Dim DS2 As New DataSet
        'Dim tb As DataTable
    ...
    End Function
    Public Function activofijo(ByVal pFechaHasta As String)
        'Dim DS2 As New DataSet
        'Dim tb As DataTable
    ...
    End Function
    Public Function activodiferido(ByVal pFechaHasta As String)
        'Dim DS2 As New DataSet
        'Dim tb As DataTable
    ...
    End Function
    Public Function activoOtros(ByVal pFechaHasta As String)
        'Dim DS2 As New DataSet
        'Dim tb As DataTable
    ...
    End Function
    Public Function pasivo(ByVal pFechaHasta As String)
        'Dim DS2 As New DataSet
        'Dim tb As DataTable
    ...
    End Function
    Public Function pasivofIJO(ByVal pFechaHasta As String)
        'Dim DS2 As New DataSet
        'Dim tb As DataTable
    ...
    End Function
    Public Function pasivoDiferido(ByVal pFechaHasta As String)
        'Dim DS2 As New DataSet
        'Dim tb As DataTable
    ...
    End Function
    Public Function CAPITAL(ByVal pFechaHasta As String)
        'Dim DS2 As New DataSet
        'Dim tb As DataTable
        ...
        Comm.CommandText += "  where (tblccontables.Cuenta>='" + capital1 + "' and tblccontables.Cuenta<='" + capital1 + "') or (tblccontables.Cuenta>='" + capital3 + "' and tblccontables.Cuenta<='" + capital4 + "') group by tblccontables.Cuenta order by tblccontables.Cuenta "
        ' Comm.CommandText += "  where tblccontables.Nivel<=2  "
        Dim DS2 As New DataSet
        Dim DA2 As New MySql.Data.MySqlClient.MySqlDataAdapter(Comm)
    ...
    End Function
    Public Function OrdenAcre(ByVal pFechaHasta As String)
        'Dim DS2 As New DataSet
        'Dim tb As DataTable
        ...
        If ordenVisible = 1 Then
            Comm.CommandText += " tblPolizas.fecha>='" + anio + "/01/01' and tblPolizas.fecha<='" + pFechaHasta + "' "
        Else
            Comm.CommandText += " tblPolizas.fecha>='4000/01/01' and tblPolizas.fecha<='4000/02/01' "
        End If
    ...
    End Function
    Public Function OrdenDeu(ByVal pFechaHasta As String)
        'Dim DS2 As New DataSet
        'Dim tb As DataTable
    ...
    Public Function nombreResultado()
        ...
        Return nom
    End Function
    Public Function egresos(ByVal pFechaHasta As String)
        ...
        Comm.CommandText += " tblPolizas.fecha>='" + anio + "/" + Date.Parse(pFechaHasta).Month.ToString("00") + "/01' and tblPolizas.fecha<='" + Date.Parse(anio + "/" + Date.Parse(pFechaHasta).Month.ToString("00") + "/01").AddMonths(1).AddDays(-1).ToString("yyyy/MM/dd") + "' "
    ...
    End Function
    Public Function ingresos(ByVal pFechaHasta As String)
    ...
    End Function
    Public Function sumaEdoResTodo(ByVal pFechaHasta As String)
        Dim saldo As Double
    ...
    Public Function sumaCapitalYEdo(ByVal pFechaHasta As String)
        Dim saldo As Double
        Comm.CommandText = "delete from tblSaldos;"
    ...
    End Function
    Public Function sumaEdoResMes(ByVal pFechaHasta As String) As Double
        Dim saldo As Double
        Dim saldoE As Double
        Comm.CommandText = "delete from tblSaldos;"
    ...
    Public Function conciliacionDIOT(ByVal pDesde As String, ByVal pHasta As String, ByVal ptipo As String) As DataView
        ...
        Comm.CommandText = " Select tblpolizasdetalles.DIOTHabilitado as Selec,tblpolizasdetalles.id as ID, tblpolizasdetalles.Factura as Cod,tblproveedores.RFC as RFC, tblproveedores.nombre as Prov,if(tblpolizasdetalles.ieps=0 and tblpolizasdetalles.ivaret=0,if(tblpolizasdetalles.iva=0 or tblpolizasdetalles.iva='E',tblpolizasdetalles.valorActos,if(tblpolizasdetalles.cargo=-999999999,(tblpolizasdetalles.abono*100)/tblpolizasdetalles.iva,(tblpolizasdetalles.cargo*100)/tblpolizasdetalles.iva)),if(tblpolizasdetalles.ieps=0,if(tblpolizasdetalles.cargo=-999999999,(tblpolizasdetalles.abono*100)/tblpolizasdetalles.ivaret,(tblpolizasdetalles.cargo*100)/tblpolizasdetalles.ivaret),if(tblpolizasdetalles.cargo=-999999999,(tblpolizasdetalles.abono*100)/tblpolizasdetalles.ieps,(tblpolizasdetalles.cargo*100)/tblpolizasdetalles.ieps))) as valor,tblpolizasdetalles.iva as ivaP,if(tblpolizasdetalles.ieps=0 and tblpolizasdetalles.ivaret=0,if(tblpolizasdetalles.cargo=-999999999,tblpolizasdetalles.abono,tblpolizasdetalles.cargo),0) as iva," +
            ...
            " from tblpolizasdetalles inner join tblproveedores on tblproveedores.idproveedor=tblpolizasdetalles.idProveedor inner join tblpolizas on tblpolizas.id=tblpolizasdetalles.idPoliza where tblpolizasdetalles.esDiot<>0 and tblpolizasdetalles.idproveedor<>0"
        Comm.CommandText += " and tblpolizasdetalles.fechaDiot>='" + pDesde + "' and tblpolizasdetalles.fechaDiot<='" + pHasta + "'"
        If ptipo <> "T" Then
            Comm.CommandText += " and tblpolizas.tipo='" + ptipo + "'"
        End If
    ...
    "sum(if(tblpolizasdetalles.iva=0 or tblpolizasdetalles.iva='E',tblpolizasdetalles.valorActos,0)) as cantidadivacero,tblpolizasdetalles.ivaret,tblpolizasdetalles.ieps from tblpolizasdetalles inner join tblproveedores on tblproveedores.idproveedor=tblpolizasdetalles.idProveedor inner join tblpolizas on tblpolizas.id=tblpolizasdetalles.idPoliza where tblpolizasdetalles.esDiot<>0 and tblpolizasdetalles.idproveedor<>0 "
        Comm.CommandText += " and tblpolizasdetalles.fechaDiot>='" + pDesde + "' and tblpolizasdetalles.fechaDiot<='" + pHasta + "' and tblpolizasdetalles.diothabilitado=0"
        If ptipo <> "T" Then
            Comm.CommandText += " and tblpolizas.tipo='" + ptipo + "'"
        End If
...
"tblpolizasdetalles.descripcion, if(tblpolizasdetalles.cargo=-999999999,0,tblpolizasdetalles.cargo) as cargo,if(tblpolizasdetalles.abono=-999999999,0,tblpolizasdetalles.abono) as abono, tblcontabilidadsaldosi.saldoI as saldoI " +
"from tblpolizasdetalles inner join tblpolizas on tblpolizasdetalles.idPoliza=tblpolizas.id " +
 ...
 "and concat(LPAD(c.cuenta," + NNiv1.ToString + ",'0'),if(c.n2='','',LPAD(c.n2," + NNiv2.ToString + ",'0')),if(c.n3='','',LPAD(c.n3," + NNiv3.ToString + ",'0')),if(c.n4='','',LPAD(c.n4," + NNiv4.ToString + ",'0')),if(c.n5='','',LPAD(c.n5," + NNiv5.ToString + ",'0')))>='" + inicioRango + "' and concat(LPAD(c.cuenta," + NNiv1.ToString + ",'0'),if(c.n2='','',LPAD(c.n2," + NNiv2.ToString + ",'0')),if(c.n3='','',LPAD(c.n3," + NNiv3.ToString + ",'0')),if(c.n4='','',LPAD(c.n4," + NNiv4.ToString + ",'0')),if(c.n5='','',LPAD(c.n5," + NNiv5.ToString + ",'0')))<='" + finRango + "' " +
"order by c.cuenta,tblpolizas.fecha,tblpolizas.tipo,tblpolizas.numero;"
    ...
    Public Function imprimirTodascuentas(ByVal fechaDesde As String, ByVal fechaHasta As String) As DataView
        Dim ds As New DataSet
        Comm.CommandText = "select concat(LPAD(c.cuenta," + NNiv1.ToString + ",'0'),' ',if(c.n2='','',LPAD(c.n2," + NNiv2.ToString + ",'0')),' ',if(c.n3='','',LPAD(c.n3," + NNiv3.ToString + ",'0')),' ',if(c.n4='','',LPAD(c.n4," + NNiv4.ToString + ",'0')),' ',if(c.n5='','',LPAD(c.n5," + NNiv5.ToString + ",'0'))) as concaComple, c.descripcion as des_cuenta, c.naturaleza as Naturaleza,tblpolizas.fecha as fecha,tblpolizas.tipo as tipo, tblpolizas.numero as numero," +
"tblpolizasdetalles.descripcion, if(tblpolizasdetalles.cargo=-999999999,0,tblpolizasdetalles.cargo) as cargo,if(tblpolizasdetalles.abono=-999999999,0,tblpolizasdetalles.abono) as abono, tblcontabilidadsaldosi.saldoI as saldoI " +
"from tblpolizasdetalles inner join tblpolizas on tblpolizasdetalles.idPoliza=tblpolizas.id " +
"inner join tblccontables as c on tblpolizasdetalles.idCuenta = c.idccontable " +
"inner join tblcontabilidadsaldosi on tblcontabilidadsaldosi.idccontable=c.idccontable where tblPolizas.tipo<>'A' " +
"and tblPolizas.fecha>='" + fechaDesde + "' and tblPolizas.fecha<='" + fechaHasta + "' " +
"order by c.cuenta,tblpolizas.fecha,tblpolizas.tipo,tblpolizas.numero;"
        Dim da As New MySql.Data.MySqlClient.MySqlDataAdapter(Comm)
    ...
    Public Function listaCuentas() As List(Of String)
        ...
        Return aux
    End Function
    Public Sub todosLosSaldos(ByVal pDesde As String, ByVal pHasta As String)
...
" from tblpolizasdetalles inner join tblPolizas on tblpolizasdetalles.idPoliza=tblPolizas.id where "
        If mes = "01" Then
            Comm.CommandText += "tblPolizas.fecha>='" + anio.ToString + "/01/01' and tblPolizas.fecha<='" + anio.ToString + "/12/31' and tblPolizas.tipo='A' "
        Else
            Comm.CommandText += "tblPolizas.fecha>='" + anio.ToString + "/01/01' and tblPolizas.fecha<'" + fechaDesde + "' "
        End If
        'Comm.CommandText += " and concat(tblccontables.Cuenta,tblccontables.N2)=(select concat(conta.Cuenta,conta.N2) from tblccontables as conta where conta.idCContable=tblpolizasdetalles.idCuenta)) as saldoInicial " +
        Comm.CommandText += " and tblpolizasdetalles.idCuenta=tblccontables.idccontable) as saldoInicial" +
...
" and tblccontables.cuenta<='" + hasta + "';"
    ...
    Public Sub LlenaDatosDetalle(pid As Integer)
        ...
        Comm.CommandText = "select * from tblpolizadetalles where id=" + pid.ToString
    ...
    Public Function ConsultaDetalles(ByVal pIdPoliza As Integer) As DataView
        Dim DS As New DataSet
        Comm.CommandText = "select id,idcuenta,cuenta,descripcion,if(cargo=-999999999,'',cargo) as cargo,if(abono=-999999999,'',abono) as abono from tblpolizadetalles where idpoliza=" + pIdPoliza.ToString
        Dim DA As New MySql.Data.MySqlClient.MySqlDataAdapter(Comm)
