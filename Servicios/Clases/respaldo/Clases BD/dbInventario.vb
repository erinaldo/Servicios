Public Class dbInventario
    ...
    Public Function Consulta(ByVal pIdAlmacen As Integer, Optional ByVal pNombre As String = "", Optional ByVal pClave As String = "", Optional ByVal pidClasificacion As Integer = -1, Optional ByVal ClaveyNombre As Boolean = False, Optional ByVal pidClasificacion2 As Integer = 0, Optional ByVal pidClasificacion3 As Integer = 0, Optional ByVal pClave2 As String = "", Optional ByVal pInventariable As Byte = 0, Optional ByVal pFabricante As Boolean = False, Optional ByVal pModoB As Byte = 0, Optional ByVal pEskit As Byte = 0, Optional pDescontinuado As Byte = 0) As DataView
        ...
        'Comm.CommandText = "select idinventario,clave,nombre,spdainventario(idinventario," + pIdAlmacen.ToString + ",0) from tblinventario where idinventario>1" 'and concat(clave,clave2,nombre) like '%" + Replace(pNombre, "'", "''") + "%'"
        If pIdAlmacen > 0 Then
            Comm.CommandText = "select idinventario,clave,nombre,ifnull((select cantidad from tblalmacenesi where tblalmacenesi.idinventario=tblinventario.idinventario and idalmacen=" + pIdAlmacen.ToString + "),0) as cantidad from tblinventario where idinventario>1" 'and concat(clave,clave2,nombre) like '%" + Replace(pNombre, "'", "''") + "%'"
        Else
            Comm.CommandText = "select idinventario,clave,nombre,ifnull((select sum(cantidad) from tblalmacenesi where tblalmacenesi.idinventario=tblinventario.idinventario),0) as cantidad from tblinventario where idinventario>1" 'and concat(clave,clave2,nombre) like '%" + Replace(pNombre, "'", "''") + "%'"
        End If
        '            If pIdAlmacen > 0 Then
    ...
    Public Function ConsultaInventarioPorAlmacen(ByVal pidSucursal As Integer, ByVal pIdAlmacen As Integer, ByVal pidinventario As Integer) As DataView
        Dim DS As New DataSet
        Comm.CommandText = "select tblsucursales.nombre as snombre,tblalmacenes.nombre as anombre,tblalmacenesi.cantidad from tblalmacenes inner join tblsucursales on tblalmacenes.idsucursal=tblsucursales.idsucursal inner join tblalmacenesi on tblalmacenes.idalmacen=tblalmacenesi.idalmacen where tblalmacenesi.idinventario=" + pidinventario.ToString
        If pidSucursal > 0 Then
    ...
    End Sub
    Public Function BuscaArticulo(ByVal pClave As String, ByVal pInventariable As Byte) As Boolean
        Dim Encontro As Integer
        'Comm.CommandText = " select if((select idinventario from tblinventario where idinventario>1 and clave='" + Replace(pClave, "'", "''") + "') is null,0,(select idinventario from tblinventario where idinventario>1 and clave='" + Replace(pClave, "'", "''") + "'))"
        If pClave <> "" Then
            If pInventariable = 0 Then
                Comm.CommandText = "select ifnull((select idinventario from tblinventario where idinventario>1 and descontinuado=0 and (clave='" + Replace(pClave, "'", "''") + "' or clave2='" + Replace(pClave, "'", "''") + "') limit 1),0)"
            Else
                Comm.CommandText = "select ifnull((select idinventario from tblinventario where idinventario>1 and descontinuado=0 and inventariable=1 and (clave='" + Replace(pClave, "'", "''") + "' or clave2='" + Replace(pClave, "'", "''") + "') limit 1),0)"
            End If
    ...
    Public Function DaIdArticulo(ByVal pClave As String) As Boolean
        ...
        If pClave <> "" Then
            ...
            'Else
            'Comm.CommandText = "select ifnull((select idinventario from tblinventario where idinventario>1 and inventariable=1 and (clave='" + Replace(pClave, "'", "''") + "' or clave2='" + Replace(pClave, "'", "''") + "') limit 1),0)"
            'End If
            Encontro = Comm.ExecuteScalar
            If Encontro = 0 Then
                Return False
        ...
        End If
    End Function
    Public Function DaInventario(ByVal pIdAlmacen As Integer, ByVal pIdInventario As Integer) As Double
    ...
    Public Function ReporteInventario(ByVal pIdAlmacen As Integer, ByVal pIdInventario As Integer, ByVal pidClasificacion As Integer, ByVal pidClasificacion2 As Integer, ByVal pidClasificacion3 As Integer, ByVal pIdSucursal As Integer, ByVal pConUltimoCosto As Boolean, ByVal pSoloExistencia As Boolean, ByVal pSoloMovimientos As Boolean, pSoloInventariables As Boolean, pDescontinuados As Byte) As DataView
        Dim DS As New DataSet
    ...
    End Function
    Public Function ReporteInventarioporAlmacen(ByVal pIdAlmacen As Integer, ByVal pIdInventario As Integer, ByVal pidClasificacion As Integer, ByVal pidClasificacion2 As Integer, ByVal pidClasificacion3 As Integer, ByVal pIdSucursal As Integer, ByVal pConUltimoCosto As Boolean, ByVal pSoloExistencia As Boolean, ByVal pSoloMovimientos As Boolean, pDescon As Byte) As DataView
        Dim DS As New DataSet
        If pIdAlmacen < 0 Then pIdAlmacen = 0
        If pConUltimoCosto = False Then
        ...
        If pDescon = 0 Then
            Comm.CommandText += " and descontinuado=0"
        End If
        Comm.CommandText += " order by tblinventario.clave,tblinventario.nombre"
        Dim DA As New MySql.Data.MySqlClient.MySqlDataAdapter(Comm)
    ...
    Public Function ReporteInventarioAFecha(ByVal pIdAlmacen As Integer, ByVal pIdInventario As Integer, ByVal pidClasificacion As Integer, ByVal pidClasificacion2 As Integer, ByVal pidClasificacion3 As Integer, ByVal pIdSucursal As Integer, ByVal pSoloExistencia As Boolean, ByVal pSoloMovimientos As Boolean, pFecha As String, pDescon As Byte) As DataView
        Dim DS As New DataSet
        ...
        Return DS.Tables("tblrepinventario").DefaultView
    End Function
    Public Function ReporteInventarioPorClasificacion(ByVal pIdAlmacen As Integer, ByVal pIdInventario As Integer, ByVal pidClasificacion As Integer, ByVal pidClasificacion2 As Integer, ByVal pidClasificacion3 As Integer, ByVal pIdSucursal As Integer, ByVal pConUltimoCosto As Boolean, ByVal pSoloExistencia As Boolean, ByVal pSoloMovimientos As Boolean, pFecha As String, pAfecha As Boolean, pDescon As Byte) As DataView
        Dim DS As New DataSet
        If pIdAlmacen < 0 Then pIdAlmacen = 0
    ...
    End Function
    Public Function ReporteInventarioApartado(ByVal pIdAlmacen As Integer, ByVal pIdInventario As Integer, ByVal pidClasificacion As Integer, ByVal pidClasificacion2 As Integer, ByVal pidClasificacion3 As Integer, ByVal pIdSucursal As Integer, ByVal pConUltimoCosto As Boolean, pDescon As Byte) As DataView
        Dim DS As New DataSet
        If pIdAlmacen < 0 Then pIdAlmacen = 0
        If pConUltimoCosto = False Then
    ...
    Public Function ReporteMaxMin(ByVal pIdAlmacen As Integer, ByVal pIdInventario As Integer, ByVal pidClasificacion As Integer, ByVal pidClasificacion2 As Integer, ByVal pidClasificacion3 As Integer, ByVal pIdSucursal As Integer, ByVal pConUltimoCosto As Boolean, ByVal pSoloExistencia As Boolean, ByVal pSoloMovimientos As Boolean, pDescon As Byte) As DataView
        Dim DS As New DataSet
        If pIdAlmacen < 0 Then pIdAlmacen = 0
        If pConUltimoCosto = False Then
    ...
    End Function
    Public Function ReporteCostos(ByVal pIdAlmacen As Integer, ByVal pIdInventario As Integer, ByVal pTipoCosteo As Byte, ByVal pTipodeCambio As Double, ByVal pidClasificacion As Integer, ByVal pidClasificacion2 As Integer, ByVal pidClasificacion3 As Integer, ByVal pidSucursal As Integer, ByVal pconUltimoCosto As Boolean, psinExistencia As Boolean, pDescon As Byte) As DataView
        Dim DS As New DataSet
        If pconUltimoCosto = False Then
            If pTipoCosteo = 2 Then
                Comm.CommandText = "select idinventario,clave,nombre,spdainventario(idinventario," + pIdAlmacen.ToString + "," + pidSucursal.ToString + ") as existencia,spsacacostoarticulo(idinventario," + pTipoCosteo.ToString + ",contenido," + pTipodeCambio.ToString + ") as costo from tblinventario where idinventario>1 "
            Else
                Comm.CommandText = "select idinventario,clave,nombre,spdainventario(idinventario," + pIdAlmacen.ToString + "," + pidSucursal.ToString + ") as existencia,costobase as costo from tblinventario where idinventario>1 "
            End If
        Else
    ...
    Public Sub DaUltimaCompra(ByVal pIdInventario As Integer)
    ...
    Public Sub LlenaTablaConciliacion(ByVal pFecha As String, ByVal pidSucursal As Integer, ByVal pIdAlmacen As Integer, ByVal pidLista As Integer, pSoloExistencia As Boolean)
        ...
        Comm.ExecuteNonQuery()
        Comm.CommandText = "insert into tblinventarioconciliaciones(fecha,idsucursal,idalmacen,idinventario,invactual,existencia,diferencia,precio,importedif) select '" + pFecha + "'," + pidSucursal.ToString + "," + pIdAlmacen.ToString + ",i.idinventario,spdainventario(i.idinventario," + pIdAlmacen.ToString + "," + pidSucursal.ToString + "),spdainventario(i.idinventario," + pIdAlmacen.ToString + "," + pidSucursal.ToString + "),0,ifnull((select precio from tblinventarioprecios where idinventario=i.idinventario and idlista=" + pidLista.ToString + " limit 1),0),0  from tblinventario as i where i.idinventario>1"
        If pSoloExistencia Then
            Comm.CommandText += " and spdainventario(idinventario," + pIdAlmacen.ToString + "," + pidSucursal.ToString + ")<>0"
        End If
        Comm.ExecuteNonQuery()
    ...
    Public Sub RecalculaInventario(ByVal pIdinventario As Integer)
        ...
        Comm.CommandText += "update tblinventariolotes set cantidad=spdainventarioafechalotes(idlote," + pIdinventario.ToString + ",'2100/01/01',0,0) where idinventario=" + pIdinventario.ToString + ";"
        Comm.CommandText += "update tblinventarioaduana set cantidad=spdainventarioafechaaduana(idaduana," + pIdinventario.ToString + ",'2100/01/01',0,0) where idinventario=" + pIdinventario.ToString + ";"
        Comm.ExecuteNonQuery()
    ...
    Public Sub AjustaCostoSalidas(ByVal pidInventario As Integer, ByVal pFecha As String)
        Comm.CommandText = "update tblmovimientosdetalles md inner join tblmovimientos m on md.idmovimiento=m.idmovimiento inner join tblinventarioconceptos ic on m.idconcepto=ic.idconcepto set precio=(select costo from tblinventariocostoh where idinventario=md.idinventario and fecha<=m.fecha order by fecha desc limit 1)*cantidad where ic.tipo=1 and m.fecha>='" + pFecha + "' and md.idinventario=" + pidInventario.ToString
        Comm.ExecuteNonQuery()
    End Sub
