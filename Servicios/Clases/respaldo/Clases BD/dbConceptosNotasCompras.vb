Public Class dbConceptosNotasCompras
    ...
    Public Sub Guardar(ByVal pNombre As String, ByVal pTipo As String)
        Nombre = pNombre
        Tipo = pTipo
        Comm.CommandText = "insert into tblconceptosnotascompras(nombre,tipo) values('" + Replace(Nombre, "'", "''") + "'," + Tipo.ToString + ")"
    ...
    Public Sub Modificar(ByVal pID As Integer, ByVal pNombre As String, ByVal pTipo As String)
        ...
        Nombre = pNombre
        Tipo = pTipo
        Comm.CommandText = "update tblconceptosnotascompras set nombre='" + Replace(Nombre, "'", "''") + "',tipo=" + Tipo.ToString + " where idconceptonotacompra=" + ID.ToString
        Comm.ExecuteNonQuery()
    End Sub
