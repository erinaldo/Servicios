Public Class dbInventarioClasificaciones
    ...
    Public Sub Guardar(ByVal pNombre As String, ByVal pCodigo As String, Optional ByVal pIdNivelSuperior As Integer = 1)
        ...
        Else
            Comm.CommandText = "insert into " + Tabla + "(nombre,codigo,idnivelsuperior) values('" + Replace(Nombre, "'", "''") + "','" + Replace(Codigo, "'", "''") + "'," + IdNivelSuperior.ToString + ")"
        End If
    ...
    Public Sub Modificar(ByVal pID As Integer, ByVal pNombre As String, ByVal pCodido As String)
        ...
        Nombre = pNombre
        Codigo = pCodido
        Comm.CommandText = "update " + Tabla + " set nombre='" + Replace(Nombre, "'", "''") + "',codigo='" + Replace(Codigo, "'", "''") + "' where idclasificacion=" + ID.ToString
        Comm.ExecuteNonQuery()
    End Sub
