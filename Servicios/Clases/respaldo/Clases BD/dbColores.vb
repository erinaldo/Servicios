Public Class dbColores
    ...
    Public Sub Guardar(ByVal pNombre As String, ByVal pDireccion As String, ByVal pComentario As String)
        ...
        Comm.CommandText = "insert into tblcolores(nombre,codigo,comentario) values('" + Replace(Nombre, "'", "''") + "','" + Replace(Codigo, "'", "''") + "','" + Replace(Comentario, "'", "''") + "')"
    ...
    Public Sub Modificar(ByVal pID As Integer, ByVal pNombre As String, ByVal pDireccion As String, ByVal pComentario As String)
        ...
        Codigo = pDireccion
        Comentario = pComentario
        Comm.CommandText = "update tblcolores set nombre='" + Replace(Nombre, "'", "''") + "',codigo='" + Replace(Codigo, "'", "''") + "',comentario='" + Replace(Comentario, "'", "''") + "' where idcolor=" + ID.ToString
        Comm.ExecuteNonQuery()
    End Sub
