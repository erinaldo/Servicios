Public Class dbVentasPedidos
    ...
    Public Sub LlenaDatos()
        ...
        Comm.CommandText = "select * from tblventaspedidos where idpedido=" + ID.ToString
    ...
    Public Sub Guardar(ByVal pIdCliente As Integer, ByVal pFecha As String, ByVal pFolio As Integer, ByVal pDesglosar As Byte, ByVal pIva As Double, ByVal pidSucursal As Integer, ByVal pSerie As String, ByVal pidCaja As Integer, ByVal pIdVendedor As Integer)
        ...
        Serie = pSerie
        IdCaja = pidCaja
        Comm.CommandText = "insert into tblventaspedidos(idcliente,fecha,folio,total,hora,estado,iva,totalapagar,desglosar,idsucursal,serie,idcaja,usado,idvendedor,comentario) values(" + IdCliente.ToString + ",'" + Fecha + "'," + Folio.ToString + ",0,'" + Format(TimeOfDay, "HH:mm:ss") + "'," + CStr(Estados.SinGuardar) + "," + Iva.ToString + ",0," + Desglosar.ToString + "," + IdSucursal.ToString + ",'" + Replace(Trim(Serie), "'", "''") + "'," + IdCaja.ToString + ",0," + IdVendedor.ToString + ",'')"
        Comm.ExecuteNonQuery()
        Comm.CommandText = "select max(idpedido) from tblventaspedidos"
    ...
    Public Function Reporte(ByVal pFecha1 As String, ByVal pFecha2 As String, ByVal pIdSucursal As Integer, ByVal pIdCliente As Integer, ByVal pMostrarEnPesos As Byte, ByVal pSoloCanceladas As Boolean, ByVal pIdVendedor As Integer, ByVal pSerie As String, pidCaja As Integer) As DataView
        ...
        "from tblventaspedidos v inner join tblclientes c on v.idcliente=c.idcliente where v.fecha>='" + pFecha1 + "' and v.fecha<='" + pFecha2 + "'"
        'End If
