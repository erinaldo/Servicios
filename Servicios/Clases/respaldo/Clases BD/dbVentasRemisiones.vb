Public Class dbVentasRemisiones
    ...
    Public Sub LlenaDatos()
        ...
        Comm.CommandText = "select * from tblventasremisiones where idremision=" + ID.ToString
    ...
    Public Function Consulta(ByVal pFecha As String, ByVal pFecha2 As String, ByVal pNombreClave As String, ByVal pFolio As String, ByVal pEstado As Byte, ByVal pUsado As Byte, ByVal pidSucursal As Integer, ByVal pIdForma As Integer, ByVal pSerieoc As String, ByVal pMostraroc As Byte, ByVal pSurtido As Byte) As DataView
        ...
        End If
        Comm.CommandText += " order by tblventasremisiones.fecha,tblventasremisiones.serie,tblventasremisiones.folio"
    ...
    Public Sub AgregarDetallesReferencia(ByVal PidRemision As Integer, ByVal pIdDocumento As Integer, ByVal Tipo As Byte, ByVal pidAlmacen As Integer)
        ...
        If Tipo = 0 Then
            Comm.CommandText = "insert into tblventasremisionesinventario(idremision,idinventario,cantidad,precio,descripcion,idmoneda,idalmacen,iva,extra,descuento,idvariante,idservicio,surtido,preciooriginal,IEPS,ivaRetenido,cantidadm,tipocantidadm) select " + PidRemision.ToString + ",idinventario,cantidad,precio,descripcion,idmoneda," + pidAlmacen.ToString + ",iva,extra,descuento,idvariante,0,0,precio,IEPS,ivaRetenido,cantidad,(select tipocontenido from tblinventario where idinventario=tblventascotizacionesinventario.idinventario) from tblventascotizacionesinventario where idcotizacion=" + pIdDocumento.ToString
            Comm.ExecuteNonQuery()
            Comm.CommandText = "update tblinventarioseries set idremision=" + PidRemision.ToString + ",idcotizacion=0 where idcotizacion=" + pIdDocumento.ToString
            Comm.ExecuteNonQuery()
            'Comm.CommandText = "insert into tblventasremisionesproductos(idremision,idvariante,cantidad,precio,descripcion,idmoneda,idalmacen,iva,extra,descuento) select " + PidRemision.ToString + ",idvariante,cantidad,precio,descripcion,idmoneda," + pidAlmacen.ToString + ",iva,extra,descuento from tblventascotizacionesproductos where idcotizacion=" + pIdDocumento.ToString
        ...
        If Tipo = 2 Then
            Comm.CommandText = "insert into tblventasremisionesinventario(idremision,idinventario,cantidad,precio,descripcion,idmoneda,idalmacen,iva,extra,descuento,idvariante,idservicio,surtido,preciooriginal,IEPS,ivaRetenido,cantidadm,tipocantidadm) select " + PidRemision.ToString + ",idinventario,cantidad,precio,descripcion,idmoneda,idalmacen,iva,extra,descuento,idvariante,idservicio,0,precio,IEPS,ivaRetenido,cantidadm,tipocantidadm from tblventasremisionesinventario where idremision=" + pIdDocumento.ToString
            Comm.ExecuteNonQuery()
        ...
        If Tipo = 3 Then
            Comm.CommandText = "insert into tblventasremisionesinventario(idremision,idinventario,cantidad,precio,descripcion,idmoneda,idalmacen,iva,extra,descuento,idvariante,idservicio,surtido,preciooriginal,IEPS,ivaRetenido,cantidadm,tipocantidadm) select " + PidRemision.ToString + ",idinventario,cantidad,precio,descripcion,idmoneda,idalmacen,iva,extra,descuento,idvariante,idservicio,0,precio,IEPS,ivaRetenido,cantidadm,tipocantidadm from tblventasinventario where idventa=" + pIdDocumento.ToString
            Comm.ExecuteNonQuery()
    ...
    Public Sub RegresaInventario(ByVal pId As Integer)
        ...
        If iUsado = 0 Then
            ...
            Comm.CommandText += "select spmodificainventariolotesf(tblventasremisioneslotes.idlote,tblventasremisioneslotes.surtido,0,0,0) from tblventasremisioneslotes inner join tblventasremisionesinventario on tblventasremisioneslotes.iddetalle = tblventasremisionesinventario.iddetalle where tblventasremisionesinventario.idremision=" + pId.ToString + ";"
            Comm.CommandText += "select spmodificainventarioaduanaf(tblventasremisionesaduana.idaduana,tblventasremisionesaduana.surtido,0,0,0) from tblventasremisionesaduana inner join tblventasremisionesinventario on tblventasremisionesaduana.iddetalle = tblventasremisionesinventario.iddetalle where tblventasremisionesinventario.idremision=" + pId.ToString + ";"
            Comm.ExecuteNonQuery()
    ...
    Public Sub ModificaInventario(ByVal pId As Integer, ByVal pPorSurtir As Byte)
        If PorSurtir = 0 Then
            ...
            Comm.ExecuteNonQuery()
            Comm.CommandText = "select spmodificainventariolotesf(tblventasremisioneslotes.idlote,tblventasremisioneslotes.cantidad-tblventasremisioneslotes.surtido,0,1,0) from tblventasremisioneslotes inner join tblventasremisionesinventario on tblventasremisioneslotes.iddetalle=tblventasremisionesinventario.iddetalle where tblventasremisionesinventario.idremision=" + pId.ToString + ";"
            Comm.CommandText += "select spmodificainventarioaduanaf(tblventasremisionesaduana.idaduana,tblventasremisionesaduana.cantidad-tblventasremisionesaduana.surtido,0,1,0) from tblventasremisionesaduana inner join tblventasremisionesinventario on tblventasremisionesaduana.iddetalle=tblventasremisionesinventario.iddetalle where tblventasremisionesinventario.idremision=" + pId.ToString + ";"
    ...
    'End Function
    Public Function Reporte(ByVal pFecha1 As String, ByVal pFecha2 As String, ByVal pIdSucursal As Integer, ByVal pIdCliente As Integer, ByVal pMostrarEnPesos As Byte, ByVal pSoloCanceladas As Boolean, ByVal pUsado As Boolean, ByVal pIdVendedor As Integer, ByVal pSerieOc As String, ByVal pMostrarOc As Byte, ByVal pSerie As String, ByVal pZona As Integer, ByVal pZona2 As Integer, ByVal pSoloActivas As Boolean, pIdCaja As Integer) As DataView
        Dim DS As New DataSet
        If pMostrarEnPesos = 0 Then
            Comm.CommandText = "select v.idremision idventa,v.fecha,v.folio,v.serie,v.estado,if(v.idmoneda=2,round(v.total,2),round(v.total*v.tipodecambio,2)) as total,if(v.idmoneda=2,round(v.totalapagar,2),round(v.totalapagar*v.tipodecambio,2)) as totalapagar,v.fecha,v.tipodecambio,v.idmoneda,c.nombre as cnombre,v.usado,if(v.idventar=0,'',(select concat(serie,convert(folio using utf8)) from tblventas where idventa=v.idventar)) as ref,fp.tipo " + _
            "from tblventasremisiones v inner join tblclientes c on v.idcliente=c.idcliente inner join tblformasdepagoremisiones as fp on v.idforma=fp.idforma inner join tblvendedores on v.idvendedor=tblvendedores.idvendedor where  v.fecha>='" + pFecha1 + "' and v.fecha<='" + pFecha2 + "'"
        Else
            Comm.CommandText = "select v.idremision idventa,v.fecha,v.folio,v.serie,v.estado,round(v.total,2) as total,round(v.totalapagar,2) as totalapagar,v.fecha,v.tipodecambio,v.idmoneda,c.nombre as cnombre,v.usado,if(v.idventar=0,'',(select concat(serie,convert(folio using utf8)) from tblventas where idventa=idventar)) as ref,fp.tipo " + _
            "from tblventasremisiones v inner join tblclientes c on v.idcliente=c.idcliente inner join tblformasdepagoremisiones as fp on v.idforma=fp.idforma inner join tblvendedores on v.idvendedor=tblvendedores.idvendedor where  v.fecha>='" + pFecha1 + "' and v.fecha<='" + pFecha2 + "'"
        End If
    ...
    Public Function ReporteCanceladas(ByVal pFecha1 As String, ByVal pFecha2 As String, ByVal pIdSucursal As Integer, ByVal pIdCliente As Integer, ByVal pMostrarEnPesos As Byte, ByVal pSoloCanceladas As Boolean, ByVal pUsado As Boolean, ByVal pIdVendedor As Integer, ByVal pSerieOc As String, ByVal pMostrarOc As Byte, ByVal pSerie As String, ByVal pZona As Integer, ByVal pZona2 As Integer, ByVal pSoloActivas As Boolean, pIdCaja As Integer) As DataView
        ...
        If pMostrarEnPesos = 0 Then
            Comm.CommandText = "select v.idremision idventa,v.fecha,v.folio,v.serie,v.estado,if(v.idmoneda=2,round(v.total,2),round(v.total*v.tipodecambio,2)) as total,if(v.idmoneda=2,round(v.totalapagar,2),round(v.totalapagar*v.tipodecambio,2)) as totalapagar,v.fecha,v.tipodecambio,v.idmoneda,c.nombre as cnombre,v.usado,if(v.idventar=0,'',(select concat(serie,convert(folio using utf8)) from tblventas where idventa=v.idventar)) as ref,fp.tipo " + _
            "from tblventasremisiones v inner join tblclientes c on v.idcliente=c.idcliente inner join tblformasdepagoremisiones as fp on v.idforma=fp.idforma inner join tblvendedores on v.idvendedor=tblvendedores.idvendedor where  v.fechacancelado>='" + pFecha1 + "' and v.fechacancelado<='" + pFecha2 + "'"
        Else
            Comm.CommandText = "select v.idremision idventa,v.fecha,v.folio,v.serie,v.estado,round(v.total,2) as total,round(v.totalapagar,2) as totalapagar,v.fecha,v.tipodecambio,v.idmoneda,c.nombre as cnombre,v.usado,if(v.idventar=0,'',(select concat(serie,convert(folio using utf8)) from tblventas where idventa=idventar)) as ref,fp.tipo " + _
            "from tblventasremisiones v inner join tblclientes c on v.idcliente=c.idcliente inner join tblformasdepagoremisiones as fp on v.idforma=fp.idforma inner join tblvendedores on v.idvendedor=tblvendedores.idvendedor where  v.fechacancelado>='" + pFecha1 + "' and v.fechacancelado<='" + pFecha2 + "'"
        End If
        ...
        Return DS.Tables("tblremisiones").DefaultView
    End Function
    Public Function ReporteVentasArticulos(ByVal pFecha1 As String, ByVal pFecha2 As String, ByVal pIdSucursal As Integer, ByVal pIdCliente As Integer, ByVal pIdInventario As Integer, ByVal pidClasificacion As Integer, ByVal pidClasificacion2 As Integer, ByVal pidClasificacion3 As Integer, ByVal pidVendedor As Integer, ByVal pidMoneda As Integer, ByVal pMostrarEnPesos As Byte, ByVal pUsado As Boolean, ByVal pCondensado As Boolean, ByVal pSerieOc As String, ByVal pMostrarOc As Byte, ByVal pSerie As String, ByVal pPorVendedor As Boolean, ByVal pZona As Integer, ByVal pZona2 As Integer, pIdAlmacen As Integer, pidCaja As Integer) As DataView
        Dim DS As New DataSet
        If pMostrarEnPesos = 0 Then
            Comm.CommandText = "select v.idremision idventa,v.folio,v.serie,v.estado,v.total,v.totalapagar,v.fecha,v.tipodecambio,vi.idmoneda,vi.cantidad,if(vi.idinventario>1,i.nombre,if(vi.idvariante>1,p.nombre,'SERVICIO')) as descripcion,round(if(vi.idmoneda=2,vi.precio,vi.precio*v.tipodecambio),2) as precio,0 as costoinv,0 as costopro,vi.idinventario,vi.idvariante,c.nombre as cnombre,vi.iva,v.usado,round(if(vi.idmoneda=2,vi.precio/vi.cantidad,vi.precio*v.tipodecambio/vi.cantidad),2) as preciou,i.clave as codigoa,v.idvendedor,(select nombre from tblvendedores where idvendedor=v.idvendedor) as vnombre,v.porsurtir,vi.ieps,vi.ivaretenido ivaret " + _
            "from tblventasremisiones v inner join tblventasremisionesinventario vi on v.idremision=vi.idremision inner join tblinventario i on vi.idinventario=i.idinventario inner join tblproductosvariantes pv on pv.idvariante=vi.idvariante inner join tblclientes c on v.idcliente=c.idcliente inner join tblproductos p on pv.idproducto=p.idproducto inner join tblvendedores on v.idvendedor=tblvendedores.idvendedor where v.estado=3 and v.fecha>='" + pFecha1 + "' and v.fecha<='" + pFecha2 + "'"
        Else
            Comm.CommandText = "select v.idremision idventa,v.folio,v.serie,v.estado,v.total,v.totalapagar,v.fecha,v.tipodecambio,vi.idmoneda,vi.cantidad,if(vi.idinventario>1,i.nombre,if(vi.idvariante>1,p.nombre,'SERVICIO')) as descripcion,round(vi.precio,2),0 as costoinv,0 as costopro,vi.idinventario,vi.idvariante,c.nombre as cnombre,vi.iva,v.usado,round(vi.precio/vi.cantidad,2) as preciou,i.clave as codigoa,v.idvendedor,(select nombre from tblvendedores where idvendedor=v.idvendedor) as vnombre,v.porsurtir,vi.ieps,vi.ivaretenido ivaret " + _
            "from tblventasremisiones v inner join tblventasremisionesinventario vi on v.idremision=vi.idremision inner join tblinventario i on vi.idinventario=i.idinventario inner join tblproductosvariantes pv on pv.idvariante=vi.idvariante inner join tblclientes c on v.idcliente=c.idcliente inner join tblproductos p on pv.idproducto=p.idproducto inner join tblvendedores on v.idvendedor=tblvendedores.idvendedor where v.estado=3 and v.fecha>='" + pFecha1 + "' and v.fecha<='" + pFecha2 + "'"
        End If
        If pIdSucursal > 0 Then Comm.CommandText += " and v.idsucursal=" + pIdSucursal.ToString
        If pIdCliente > 0 Then Comm.CommandText += " and v.idcliente=" + pIdCliente.ToString
    ...
    End Function
    Public Function ReporteVentasArticulosClases(ByVal pFecha1 As String, ByVal pFecha2 As String, ByVal pIdSucursal As Integer, ByVal pIdCliente As Integer, ByVal pIdInventario As Integer, ByVal pidClasificacion As Integer, ByVal pidClasificacion2 As Integer, ByVal pidClasificacion3 As Integer, ByVal pidVendedor As Integer, ByVal pidMoneda As Integer, ByVal pMostrarEnPesos As Byte, ByVal pUsado As Boolean, ByVal pCondensado As Boolean, ByVal pSerieOc As String, ByVal pMostrarOc As Byte, ByVal pSerie As String, ByVal pZona As Integer, ByVal pZona2 As Integer, pIdAlmacen As Integer, pIdCaja As Integer) As DataView
        Dim DS As New DataSet
        If pMostrarEnPesos = 0 Then
            Comm.CommandText = "select v.idremision idventa,v.folio,v.serie,v.estado,v.total,v.totalapagar,v.fecha,v.tipodecambio,vi.idmoneda,vi.cantidad,i.nombre as descripcion,round(if(vi.idmoneda=2,vi.precio,vi.precio*v.tipodecambio),2) as precio,0 as costoinv,0 as costopro,vi.idinventario,c.nombre as cnombre,vi.iva,v.usado,round(if(vi.idmoneda=2,vi.precio/vi.cantidad,vi.precio*v.tipodecambio/vi.cantidad),2) as preciou,i.clave as codigoa,(select nombre from tblinventarioclasificaciones where idclasificacion=i.idclasificacion) as nclase1,(select nombre from tblinventarioclasificaciones2 where idclasificacion=i.idclasificacion2) as nclase2,(select nombre from tblinventarioclasificaciones3 where idclasificacion=i.idclasificacion3) as nclase3,i.idclasificacion,i.idclasificacion2,i.idclasificacion3,v.porsurtir,vi.ieps,vi.ivaretenido ivaret  " + _
        ...
        Else
            Comm.CommandText = "select v.idremision idventa,v.folio,v.serie,v.estado,v.total,v.totalapagar,v.fecha,v.tipodecambio,vi.idmoneda,vi.cantidad,i.nombre as descripcion,round(vi.precio,2),0 as costoinv,0 as costopro,vi.idinventario,c.nombre as cnombre,vi.iva,v.usado,round(vi.precio/vi.cantidad,2) as preciou,i.clave as codigoa,(select nombre from tblinventarioclasificaciones where idclasificacion=i.idclasificacion) as nclase1,(select nombre from tblinventarioclasificaciones2 where idclasificacion=i.idclasificacion2) as nclase2,(select nombre from tblinventarioclasificaciones3 where idclasificacion=i.idclasificacion3) as nclase3,i.idclasificacion,i.idclasificacion2,i.idclasificacion3,v.porsurtir,vi.ieps,vi.ivaretenido ivaret  " + _
    ...
    End Function
    Public Function ReportexVendedor(ByVal pFecha1 As String, ByVal pFecha2 As String, ByVal pIdSucursal As Integer, ByVal pIdCliente As Integer, ByVal pMostrarEnPesos As Byte, ByVal pSoloCanceladas As Boolean, ByVal pUsado As Boolean, ByVal pIdVendedor As Integer, ByVal pSerieOc As String, ByVal pMostrarOc As Byte, ByVal pSerie As String, ByVal pZona As Integer, ByVal pZona2 As Integer, pidCaja As Integer) As DataView
        Dim DS As New DataSet
        If pMostrarEnPesos = 0 Then
            Comm.CommandText = "select v.idremision idventa,v.fecha,v.folio,v.serie,v.estado,if(v.idmoneda=2,v.total,v.total*v.tipodecambio) as total,if(v.idmoneda=2,v.totalapagar,v.totalapagar*v.tipodecambio) as totalapagar,v.fecha,v.tipodecambio,v.idmoneda,c.nombre as cnombre,v.usado,tblvendedores.nombre as vnombre,v.idvendedor " + _
            "from tblventasremisiones v inner join tblclientes c on v.idcliente=c.idcliente inner join tblvendedores on v.idvendedor=tblvendedores.idvendedor  where  v.fecha>='" + pFecha1 + "' and v.fecha<='" + pFecha2 + "'"
        Else
            Comm.CommandText = "select v.idremision idventa,v.fecha,v.folio,v.serie,v.estado,v.total as total,v.totalapagar as totalapagar,v.fecha,v.tipodecambio,v.idmoneda,c.nombre as cnombre,v.usado,tblvendedores.nombre as vnombre,v.idvendedor " + _
            "from tblventasremisiones v inner join tblclientes c on v.idcliente=c.idcliente inner join tblvendedores on v.idvendedor=tblvendedores.idvendedor  where  v.fecha>='" + pFecha1 + "' and v.fecha<='" + pFecha2 + "'"
        End If
        If pUsado Then
            Comm.CommandText += " and v.usado=0"
        ...
        Return DS.Tables("tblremisiones").DefaultView
    End Function
    Public Function ReporteVentasArticulosMasVendidos(ByVal pFecha1 As String, ByVal pFecha2 As String, ByVal pIdSucursal As Integer, ByVal pIdCliente As Integer, ByVal pIdInventario As Integer, ByVal pidClasificacion As Integer, ByVal pidClasificacion2 As Integer, ByVal pidClasificacion3 As Integer, ByVal pidVendedor As Integer, ByVal pidMoneda As Integer, ByVal pMostrarEnPesos As Byte, ByVal pSerie As String, ByVal pOrdenxVendedor As Boolean, ByVal pLimite As String, ByVal pTipoOrden As Byte, ByVal pMostrarOc As Byte, ByVal pSerieOc As String, ByVal pZona As Integer, ByVal pZona2 As Integer, pIdAlmacen As Integer, pIdCaja As Integer) As DataView
        Dim DS As New DataSet
        If pMostrarEnPesos = 0 Then
    ...
    Public Sub ActualizaComentario(ByVal pidRemision As Integer, ByVal pTexto As String)
        ...
        Comm.ExecuteNonQuery()
    End Sub
    Public Function ReporteUtilidad(ByVal pFecha1 As String, ByVal pFecha2 As String, ByVal pIdSucursal As Integer, ByVal pIdCliente As Integer, ByVal pidVendedor As Integer, ByVal pidMoneda As Integer, ByVal pMostrarEnPesos As Byte, ByVal pidinventario As Integer, ByVal pidclasificacion1 As Integer, ByVal pidclasificacion2 As Integer, ByVal pidclasificacion3 As Integer, ByVal ptipoCosteo As Byte, ByVal pSerie As String, ByVal pZona As Integer, ByVal pZona2 As Integer, ByVal pMostrarOc As Byte, ByVal pSeriesOC As String, pIdAlmacen As Integer, pidCaja As Integer) As DataView
        Dim DS As New DataSet
    ...
    "ifnull((select costo from tblinventariocostoh where idinventario=tblventasinventario.idinventario and fecha<=tblventas.fecha order by fecha desc limit 1),0) as costo,tblventas.porsurtir,tblventasinventario.ieps,tblventasinventario.ivaretenido ivaret " + _
    "from tblventasremisiones as tblventas inner join tblventasremisionesinventario as tblventasinventario on tblventas.idremision=tblventasinventario.idremision inner join tblinventario on tblventasinventario.idinventario=tblinventario.idinventario inner join tblclientes on tblventas.idcliente=tblclientes.idcliente inner join tblvendedores on tblventas.idvendedor=tblvendedores.idvendedor where  tblventas.estado=3 and tblventas.fecha>='" + pFecha1 + "' and tblventas.fecha<='" + pFecha2 + "'"
        Else
            Comm.CommandText = "select tblventas.idremision as idventa,tblventas.folio,tblventas.serie,tblventasinventario.cantidad,if(tblventasinventario.idmoneda=2,tblventasinventario.precio,tblventasinventario.precio*tblventas.tipodecambio) as precio,tblventasinventario.iva,tblclientes.clave,tblclientes.nombre,tblinventario.clave as clavei,tblinventario.nombre as nombrei,tblventas.fecha," + _
    "spdaultimocostoinv(tblventasinventario.idinventario) as costo,tblventas.porsurtir,tblventasinventario.ieps,tblventasinventario.ivaretenido ivaret " + _
    "from tblventasremisiones as tblventas inner join tblventasremisionesinventario as tblventasinventario on tblventas.idremision=tblventasinventario.idremision inner join tblinventario on tblventasinventario.idinventario=tblinventario.idinventario inner join tblclientes on tblventas.idcliente=tblclientes.idcliente inner join tblvendedores on tblventas.idvendedor=tblvendedores.idvendedor where  tblventas.estado=3 and tblventas.fecha>='" + pFecha1 + "' and tblventas.fecha<='" + pFecha2 + "'"
        End If
    ...
    Public Function ReporteVentasArticulosDetalle(ByVal pFecha1 As String, ByVal pFecha2 As String, ByVal pIdSucursal As Integer, ByVal pIdCliente As Integer, ByVal pIdInventario As Integer, ByVal pidClasificacion As Integer, ByVal pidClasificacion2 As Integer, ByVal pidClasificacion3 As Integer, ByVal pidVendedor As Integer, ByVal pidMoneda As Integer, ByVal pMostrarEnPesos As Byte, ByVal pConcendaso As Boolean, ByVal pSerie As String, ByVal pOrdenxVendedor As Boolean, ByVal pZona As Integer, ByVal pZona2 As Integer, ByVal PsoloCanceladas As Boolean, ByVal pSoloActivas As Boolean, pidAlmacen As Integer, pidCaja As Integer) As DataView
        ...
        If pMostrarEnPesos = 0 Then
            ...
            "from tblventasremisiones as tblventas inner join tblventasremisionesinventario as tblventasinventario on tblventas.idremision=tblventasinventario.idremision inner join tblinventario on tblventasinventario.idinventario=tblinventario.idinventario inner join tblclientes on tblventas.idcliente=tblclientes.idcliente inner join tblformasdepagoremisiones as tblformasdepago on tblformasdepago.idforma=tblventas.idforma inner join tblvendedores on tblventas.idvendedor=tblvendedores.idvendedor left outer join tblzona on tblclientes.zona=tblzona.idzona where tblventas.fecha>='" + pFecha1 + "' and tblventas.fecha<='" + pFecha2 + "' and tblventasinventario.cantidad<>0 and tblventasinventario.idinventario>1 "
        Else
