Public Class dbNominas
    ...
    Public Function DaTotal(ByVal pidCargo As Integer, ByVal pidMoneda As Integer) As Double
        ...
        '+++++++++++++++++++++++++++++++++++++++Total por Articulos ++++++++++++++++++++++++++++++++++++
        Comm.CommandText = "select iddetalle from tblnominadetalles where idnomina=" + pidCargo.ToString
        DReader = Comm.ExecuteReader
        HayConceptos = False
    ...
    Public Function CreaCadenaOriginali32(ByVal pIdVenta As Integer, ByVal pIdMoneda As Integer) As String
        ...
        While DR.Read
            ...
            CO += CStr(DR("tipoincapacidad") + 1) + "|" 'tipo
        ...
        While DR.Read
            'horas extra
            CO += DR("horasextra").ToString + "|" 'dias
            CO += DR("tipohoras") + "|" 'tipohoras
            CO += DR("dias").ToString + "|" 'horas
    ...
    Public Function CreaXMLi32(ByVal pIdVenta As Integer, ByVal pIdMoneda As Integer, ByVal pSelloDigital As String, ByVal pIdEmpresa As Integer) As String
        ...
        While DR.Read
            If Hay = 0 Then
                ...
                Hay = 1
            End If
            XMLDoc += "<nomina:Incapacidad Descuento=""" + Format(DR("descuento"), "#0.00####") + """ TipoIncapacidad=""" + CStr(DR("tipoincapacidad") + 1) + """ DiasIncapacidad=""" + DR("dias").ToString + """ />"
        End While
        DR.Close()
        If Hay = 1 Then
            XMLDoc += "</nomina:Incapacidades>"
    ...
    Public Sub AgregarDetallesReferencia(ByVal pIdNomina As Integer, ByVal pIdNominaOrigen As Integer)
        ...
        Comm.CommandText = "insert into tblnominadetalles(idnomina,tipo,tipodetalle,clave,concepto,importegravado,importeexento) select " + pIdNomina.ToString + ",tipo,tipodetalle,clave,concepto,importegravado,importeexento from tblnominadetalles where idnomina=" + pIdNominaOrigen.ToString
        Comm.ExecuteNonQuery()
