Public Class dbConceptosNotasVentas
    ...
    Public Sub Guardar(ByVal pNombre As String, ByVal pTipo As String)
        Nombre = pNombre
        Tipo = pTipo
        Comm.CommandText = "insert into tblconceptosnotasventas(nombre,tipo) values('" + Replace(Nombre, "'", "''") + "'," + Tipo.ToString + ")"
    ...
    Public Sub Modificar(ByVal pID As Integer, ByVal pNombre As String, ByVal pTipo As String)
        ...
        Nombre = pNombre
        Tipo = pTipo
        Comm.CommandText = "update tblconceptosnotasventas set nombre='" + Replace(Nombre, "'", "''") + "',tipo=" + Tipo.ToString + " where idconceptonotaventa=" + ID.ToString
        Comm.ExecuteNonQuery()
    End Sub
