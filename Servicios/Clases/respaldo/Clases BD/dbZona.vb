Public Class dbZona
    ...
    Public Function reporte() As DataView
        ...
        Comm.CommandText = "select * from tblzona;"
    ...
    Public Sub Guardar(ByVal pNombre As String)
        ...
        Comm.CommandText = "insert into tblzona(zona) values('" + Replace(pNombre, "'", "''") + "')"
        Comm.ExecuteNonQuery()
    End Sub
    Public Sub Modificar(ByVal pID As Integer, ByVal pNombre As String)
        Comm.CommandText = "update tblzona set zona='" + Replace(pNombre, "'", "''") + "'" + " where idZona=" + pID.ToString()
        Comm.ExecuteNonQuery()
    End Sub
