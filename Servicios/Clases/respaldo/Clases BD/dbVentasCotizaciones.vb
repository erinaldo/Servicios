Public Class dbVentasCotizaciones
    ...
    Public Sub LlenaDatos()
        ...
        Comm.CommandText = "select * from tblventascotizaciones where idcotizacion=" + ID.ToString
    ...
    Public Function Consulta(ByVal pFecha As String, ByVal pFecha2 As String, ByVal pNombreClave As String, ByVal pEstado As Byte, ByVal pFolio As String, ByVal pIdSucursal As Integer) As DataView
        ...
        Comm.CommandText = "select tblventascotizaciones.idcotizacion,tblventascotizaciones.fecha,tblventascotizaciones.serie,tblventascotizaciones.folio,tblclientes.clave,tblclientes.nombre as Cliente,round(tblventascotizaciones.totalapagar,2) as totalapagar,case tblventascotizaciones.estado when 2 then 'Guardado' when 3 then 'Guardado' when 4 then 'Cancelada' end  as sestado  from tblventascotizaciones inner join tblclientes on tblventascotizaciones.idcliente=tblclientes.idcliente where fecha>='" + pFecha + "' and fecha<='" + pFecha2 + "'"
        ...
        End If
        Comm.CommandText += " order by tblventascotizaciones.fecha,tblventascotizaciones.serie,tblventascotizaciones.folio"
    ...
    'End Function
    Public Function Reporte(ByVal pFecha1 As String, ByVal pFecha2 As String, ByVal pIdSucursal As Integer, ByVal pIdCliente As Integer, ByVal pMostrarEnPesos As Byte, ByVal pSoloCanceladas As Boolean, ByVal pIdVendedor As Integer, ByVal pSerie As String, pIdCaja As Integer) As DataView
        Dim DS As New DataSet
        ...
        "from tblventascotizaciones v inner join tblclientes c on v.idcliente=c.idcliente where v.fecha>='" + pFecha1 + "' and v.fecha<='" + pFecha2 + "'"
        'End If
    ...
    Public Function ReportePorArticulo(ByVal pFecha1 As String, ByVal pFecha2 As String, ByVal pIdSucursal As Integer, ByVal pIdCliente As Integer, ByVal pMostrarEnPesos As Byte, ByVal pSoloCanceladas As Boolean, ByVal pIdVendedor As Integer, ByVal pSerie As String, ByVal pidInventario As Integer, ByVal pIdClasificacion As Integer, ByVal pIdClasificacion2 As Integer, ByVal pIdClasificacion3 As Integer, pIdCaja As Integer) As DataView
        Dim DS As New DataSet
        'If pMostrarEnPesos = 0 Then
