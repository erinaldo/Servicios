Public Class dbDevolucionesCompras
    ...
    Public Function Consulta(ByVal pFecha As String, ByVal pFecha2 As String, Optional ByVal pNombreClave As String = "", Optional ByVal pFolio As String = "", Optional ByVal pEstado As Byte = 0, Optional ByVal pCredido As Byte = 200) As DataView
        ...
        ' End If
        Comm.CommandText += " order by tbldevolucionescompras.folio,tbldevolucionescompras.fecha"
    ...
    Public Function Reporte(ByVal pFecha1 As String, ByVal pFecha2 As String, ByVal pIdSucursal As Integer, ByVal pIdProveedor As Integer, ByVal pSoloCanceladas As Boolean, ByVal pMostrarEnPesos As Byte, ByVal pidInventario As Integer) As DataView
        Dim DS As New DataSet
        If pMostrarEnPesos = 0 Then
            ...
            " from tbldevolucionescompras as td inner join tbldevolucionesdetallesc as tdd on td.iddevolucion=tdd.iddevolucion where td.fecha>='" + pFecha1 + "' and td.fecha<='" + pFecha2 + "' "
        Else
