Public Class dbServicioAltaEstado
    ...
    Public Function Guardar(ByVal pnombre As String, ByVal pFinal As String) As Integer
        ...
        Comm.CommandText = "insert into tblserviciosestados( codigo,estado,final) values('0','" + Replace(nombre, "'", "''") + "'," + pFinal.ToString + ")"
    ...
    Public Sub Modificar(ByVal pID As Integer, ByVal pnombre As String, ByVal pFinal As String)
        nombre = pnombre
        ID = pID
        Comm.CommandText = "update tblserviciosestados set estado='" + Replace(nombre, "'", "''") + "', final=" + pFinal + " where idEstado=" + ID.ToString
        Comm.CommandText = Replace(Comm.CommandText, "|", "")
        Comm.ExecuteNonQuery()
    End Sub
