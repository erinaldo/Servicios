Public Class dbCompras
    ...
    Public Function ChecaFolioRepetido(ByVal pFolio As String, ByVal pIdProveedor As Integer) As Boolean
        ...
        End If
    End Function
    Public Sub Guardar(ByVal pIdProveedor As Integer, ByVal pFecha As String, ByVal pReferencia As String, ByVal pDesglosar As Byte, ByVal pIdSucursal As Integer, ByVal pTipodeCambio As Double, ByVal pIdMoneda As Integer, ByVal pidFormadePago As Integer, ByVal pFolioi As Integer, ByVal pSerie As String, ByVal pFoliocfdi As String)
    ...
    Public Sub RegresaInventario(ByVal pId As Integer, ByVal pTipoCosteo As Byte, ByVal pTipodeCambio As Double, ByVal pCosteoTiempoReal As Byte)
        ...
        Comm.CommandText += "select spmodificainventariolotesf(tblcompraslotes.idlote,tblcompraslotes.surtido,0,1,1) from tblcompraslotes inner join tblcomprasdetalles on tblcompraslotes.iddetalle=tblcomprasdetalles.iddetalle where tblcomprasdetalles.idcompra=" + pId.ToString + ";"
        Comm.CommandText += "select spmodificainventarioaduanaf(tblcomprasaduana.idaduana,tblcomprasaduana.surtido,0,1,1) from tblcomprasaduana inner join tblcomprasdetalles on tblcomprasaduana.iddetalle=tblcomprasdetalles.iddetalle where tblcomprasdetalles.idcompra=" + pId.ToString + ";"
        Comm.ExecuteNonQuery()
    ...
    Public Function ConsultaDeudas(ByVal pFecha As String, ByVal pFecha2 As String, ByVal pidCliente As Integer, ByVal pFolio As String, ByVal pidTipodePago As Integer, ByVal PorFechas As Boolean, ByVal Todas As Boolean, ByVal pTipodeOrden As Byte, ByVal pMostrarCanceladas As Boolean, ByVal pTipodeCambio As Double, ByVal pEnPesos As Boolean, ByVal pidSucursal As Integer) As DataView
        ...
        ",tblcompras.idcompra,0,tblcompras.fecha,tblcompras.estado,concat(tblcompras.serie,convert(tblcompras.folioi using utf8),'-',tblcompras.referencia),0,if(tblcompras.idmoneda=2,tblcompras.credito,tblcompras.credito*" + pTipodeCambio.ToString + "),if(tblcompras.idmoneda=2,tblcompras.totalapagar,tblcompras.totalapagar*" + pTipodeCambio.ToString + "),0 from tblcompras inner join tblproveedores on tblcompras.idproveedor=tblproveedores.idproveedor inner join tblformasdepago on tblformasdepago.idforma=tblcompras.idforma where tblcompras.idproveedor=" + pidCliente.ToString + " and tblformasdepago.tipo=" + pidTipodePago.ToString
        Else
            Comm.CommandText = "insert into tblproveedoresdeudas(idproveedor,iddocumento,tipo,fecha,estado,serie,folio,credito,totalapagar,cant) select " + pidCliente.ToString + _
        ",tblcompras.idcompra,0,tblcompras.fecha,tblcompras.estado,concat(tblcompras.serie,convert(tblcompras.folioi using utf8),'-',tblcompras.referencia),0,tblcompras.credito,tblcompras.totalapagar,0 from tblcompras inner join tblproveedores on tblcompras.idproveedor=tblproveedores.idproveedor inner join tblformasdepago on tblformasdepago.idforma=tblcompras.idforma where tblcompras.idproveedor=" + pidCliente.ToString + " and tblformasdepago.tipo=" + pidTipodePago.ToString
        End If
    ...
    Public Sub AgregarDetallesReferencia(ByVal PidCompra As Integer, ByVal pIdDocumento As Integer, ByVal Tipo As Byte, ByVal pidAlmacen As Integer)
        ...
        If Tipo = 1 Then
            Comm.CommandText = "insert into tblcomprasdetalles(idcompra,idinventario,cantidad,precio,idmoneda,iva,extra,descuento,idalmacen,surtido,costoindirecto,IEPS,ivaRetenido) select " + PidCompra.ToString + ",idinventario,cantidad,precio,idmoneda,iva,extra,descuento," + pidAlmacen.ToString + ",0,0,IEPS,ivaRetenido from tblcompraspedidosdetalles where idpedido=" + pIdDocumento.ToString
            Comm.ExecuteNonQuery()
    ...
    Public Sub ModificaInventario(ByVal pId As Integer, ByVal pTipoCosteo As Byte, ByVal pTipodeCambio As Double)
        ...
        Comm.CommandText += "select spmodificainventariolotesf(tblcompraslotes.idlote,tblcompraslotes.cantidad-tblcompraslotes.surtido,0,0,1) from tblcompraslotes inner join tblcomprasdetalles on tblcompraslotes.iddetalle = tblcomprasdetalles.iddetalle where tblcomprasdetalles.idcompra=" + pId.ToString + "; "
        Comm.CommandText += "select spmodificainventarioaduanaf(tblcomprasaduana.idaduana,tblcomprasaduana.cantidad-tblcomprasaduana.surtido,0,0,1) from tblcomprasaduana inner join tblcomprasdetalles on tblcomprasaduana.iddetalle = tblcomprasdetalles.iddetalle where tblcomprasdetalles.idcompra=" + pId.ToString + "; "
        Comm.CommandText += "update tblcompraslotes inner join tblcomprasdetalles on tblcompraslotes.iddetalle=tblcomprasdetalles.iddetalle set tblcompraslotes.surtido=tblcompraslotes.cantidad where idcompra=" + pId.ToString + ";"
    ...
    End Function
    Public Function Reporte(ByVal pFecha1 As String, ByVal pFecha2 As String, ByVal pIdSucursal As Integer, ByVal pIdProveedor As Integer, ByVal pidMoneda As Integer, ByVal pMostrarEnPesos As Byte, ByVal pSoloCanceladas As Boolean) As DataView
        Dim DS As New DataSet
        If pMostrarEnPesos = 0 Then
            Comm.CommandText = "select tblcompras.idcompra,tblcompras.referencia,tblcompras.estado,if(tblcompras.idmoneda=2,tblcompras.total,tblcompras.total*tblcompras.tipodecambio) as total,if(tblcompras.idmoneda=2,tblcompras.totalapagar,tblcompras.totalapagar*tblcompras.tipodecambio) as totalapagar,tblcompras.fecha,tblcompras.tipodecambio,tblcompras.idmoneda,tblcomprasdetalles.cantidad,tblinventario.nombre as descripcion,tblcomprasdetalles.precio,tblcomprasdetalles.idinventario,tblformasdepago.tipo as formadepago,tblproveedores.nombre as cnombre,tblcompras.costoindirecto as cindirecto,tblcompras.serie,tblcompras.folioi, " + _
        ...
        '    End If
        'End If
        Comm.CommandText += " order by tblcompras.fecha,tblcompras.referencia"
        Dim DA As New MySql.Data.MySqlClient.MySqlDataAdapter(Comm)
        DA.Fill(DS, "tblcomprasrep")
        'DS.WriteXmlSchema("tblcomprasrep.xml")
        Return DS.Tables("tblcomprasrep").DefaultView
    End Function
    Public Function ReporteComprasArticulos(ByVal pFecha1 As String, ByVal pFecha2 As String, ByVal pIdSucursal As Integer, ByVal pIdProveedor As Integer, ByVal pIdInventario As Integer, ByVal pidClasificacion As Integer, ByVal pidClasificacion2 As Integer, ByVal pidClasificacion3 As Integer, ByVal pidMoneda As Integer, ByVal pMostrarEnPesos As Byte) As DataView
        Dim DS As New DataSet
        If pMostrarEnPesos = 0 Then
            ...
            "from tblcompras inner join tblcomprasdetalles on tblcompras.idcompra=tblcomprasdetalles.idcompra inner join tblinventario on tblcomprasdetalles.idinventario=tblinventario.idinventario inner join tblformasdepago on tblformasdepago.idforma=tblcompras.idforma inner join tblproveedores on tblcompras.idproveedor=tblproveedores.idproveedor where tblcompras.estado=3 and tblcompras.fecha>='" + pFecha1 + "' and tblcompras.fecha<='" + pFecha2 + "'"
        Else
        ...
        Return DS.Tables("tblcomprasrep").DefaultView
    End Function
    Public Function ReporteProveedoresDeudas(ByVal pFecha1 As String, ByVal pFecha2 As String, ByVal pIdSucursal As Integer, ByVal pIdProveedor As Integer, ByVal pidMoneda As Integer, ByVal pMostrarEnPesos As Byte) As DataView
        Dim DS As New DataSet
        If pIdProveedor = 0 Then
    ...
    Public Function ReporteViejosSaldosH(ByVal pIdSucursal As Integer, ByVal pIdProveedor As Integer, ByVal pidMoneda As Integer, ByVal pMostrarEnPesos As Byte, ByVal pFecha1 As String, ByVal pFecha2 As String, ByVal pTipodeCambio As Double) As DataView
        ...
        If pIdProveedor <= 0 Then
            Comm.CommandText = "select fecha,tblproveedores.clave,tblproveedores.nombre,tblproveedores.idproveedor,serie,folio,limite,sietedias,quincedias,treintadias,sesentadias,tblproveedoresviejossaldos.tipo,tblproveedoresviejossaldos.credito,0 as saldoant,tblproveedoresviejossaldos.tipodecambio,tblproveedoresviejossaldos.corriente from tblproveedoresviejossaldos inner join tblproveedores on tblproveedoresviejossaldos.idproveedor=tblproveedores.idproveedor where round(totalapagar-credito,2)>0  order by tblproveedores.nombre,fecha,serie,folio"
        Else
            Comm.CommandText = "select fecha,tblproveedores.clave,tblproveedores.nombre,tblproveedores.idproveedor,serie,folio,limite,sietedias,quincedias,treintadias,sesentadias,tblproveedoresviejossaldos.tipo,tblproveedoresviejossaldos.credito,0 as saldoant,tblproveedoresviejossaldos.tipodecambio,tblproveedoresviejossaldos.corriente from tblproveedoresviejossaldos inner join tblproveedores on tblproveedoresviejossaldos.idproveedor=tblproveedores.idproveedor where tblproveedoresviejossaldos.idproveedor=" + pIdProveedor.ToString + " and round(totalapagar-credito,2)>0 order by tblproveedores.nombre,fecha,serie,folio"
        End If
    ...
    Public Function ReporteNotasDeCreditoPorConcepto(ByVal pFecha1 As String, ByVal pFecha2 As String, ByVal pIdSucursal As Integer, ByVal pIdProveedor As Integer, ByVal pidMoneda As Integer, ByVal pMostrarEnPesos As Byte, ByVal pIdConcepto As Integer) As DataView
        Dim DS As New DataSet
        If pMostrarEnPesos = 0 Then
            ...
            "from tblnotasdecreditocompras v inner join tblproveedores c on v.idproveedor=c.idproveedor inner join tblconceptosnotascompras cnv on v.idconcepto=cnv.idconceptonotacompra where v.estado=3 and v.fecha>='" + pFecha1 + "' and v.fecha<='" + pFecha2 + "'"
        Else
        ...
        If pIdProveedor > 0 Then Comm.CommandText += " and v.idcliente=" + pIdProveedor.ToString
    ...
    End Function
    Public Function ReporteNotasDeCargoPorConcepto(ByVal pFecha1 As String, ByVal pFecha2 As String, ByVal pIdSucursal As Integer, ByVal pIdProveedor As Integer, ByVal pidMoneda As Integer, ByVal pMostrarEnPesos As Byte, ByVal pidConcepto As Integer) As DataView
        Dim DS As New DataSet
        If pMostrarEnPesos = 0 Then
            ...
            "from tblnotasdecargocompras v inner join tblproveedores c on v.idproveedor=c.idproveedor inner join tblconceptosnotascompras cnv on v.idconcepto=cnv.idconceptonotacompra where v.estado=3 and v.fecha>='" + pFecha1 + "' and v.fecha<='" + pFecha2 + "'"
        Else
    ...
    Public Sub DesligaRemisiones(ByVal pIdVenta As Integer)
        Comm.CommandText = "update tblcomprasremisiones set idcomprar=0,usado=0 where idcomprar=" + pIdVenta.ToString
        Comm.ExecuteNonQuery()
        Comm.CommandText = "update tblcompras set deremision=0 where idcompra=" + pIdVenta.ToString
        Comm.ExecuteNonQuery()
    End Sub
