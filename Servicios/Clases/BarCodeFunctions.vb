...
Module BarCodeFunctions
    ...
    Public Function PrintEANBarCode(ByVal strEANCode As String, _
        ...
        Dim img As New Bitmap(254, 119, Drawing.Imaging.PixelFormat.Format24bppRgb)
        g = Graphics.FromImage(img)
        ' g = objPicBox.CreateGraphics
        '*
        ...
        If (FontForText Is Nothing) Then
            'FontForText = New Font("Courier New", 10) ' esta es la original
            FontForText = New Font("Arial", 12)
        End If
        ...
        g.FillRectangle(New System.Drawing.SolidBrush(objPicBox.BackColor), sngX1, sngY1, sngX2 - sngX1, sngY2 - sngY1)
        '*
        ...
        '* Draw the BarCode
        '*
        g.FillRectangle(Brushes.White, 0, 0, 254, 119)
        For K = 1 To Len(strEANBin)
            If Mid(strEANBin, K, 1) = "1" Then
                ...
                g.FillRectangle(New System.Drawing.SolidBrush(objPicBox.ForeColor), sngPosX, sngY1, sngScaleX, sngPosY)
            End If
        ...
        g.DrawString(strEANCode, FontForText, New System.Drawing.SolidBrush(objPicBox.ForeColor), CSng((sngX2 - sngX1) / 2), CSng(sngY2 - FontForText.Height), strFormat)
