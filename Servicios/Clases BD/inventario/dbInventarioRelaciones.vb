Public Class dbInventarioRelaciones
    ...
    Public Sub Guardar(ByVal pNombre As String, ByVal pExtra As String)
        ...
        Comm.CommandText = "insert into tblinventariorelaciones(nombre,extra,idUsuarioAlta,fechaAlta,horaAlta,idUsuarioCambio,fechaCambio,horaCambio) values('" + Replace(pNombre, "'", "''") + "','" + Replace(pExtra, "'", "''") + "'," + GlobalIdUsuario.ToString() + ",'" + DateTime.Now.ToString("yyyy/MM/dd") + "','" + TimeOfDay.ToString("HH:mm:ss") + "'," + GlobalIdUsuario.ToString() + ",'" + DateTime.Now.ToString("yyyy/MM/dd") + "','" + TimeOfDay.ToString("HH:mm:ss") + "')"
    ...
    Public Sub Modificar(ByVal pID As Integer, ByVal pNombre As String, ByVal pExtra As String)
        ID = pID
        Comm.CommandText = "update tblinventariorelaciones set nombre='" + Replace(pNombre, "'", "''") + "',extra='" + Replace(pExtra, "'", "''") + "', idUsuarioCambio=" + GlobalIdUsuario.ToString() + ", fechaCambio='" + DateTime.Now.ToString("yyyy/MM/dd") + "', horaCambio='" + TimeOfDay.ToString("HH:mm:ss") + "' where idrelacion=" + ID.ToString
        Comm.ExecuteNonQuery()
    End Sub
