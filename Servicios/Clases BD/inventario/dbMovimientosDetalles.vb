Public Class dbMovimientosDetalles
    ...
    Public Function Consulta(ByVal pIdMovimiento As Integer, pConSeries As Byte, pAduana As Byte, pverSegundoAlmacen As Boolean) As DataView
        ...
        If pverSegundoAlmacen Then
            Comm.CommandText = "select tvi.iddetalle,tvi.cantidad,tblinventario.clave,concat(tvi.descripcion,spdaseriesmovimiento(tvi.idinventario,tvi.idmovimiento," + pConSeries.ToString + "),spdadetallesaduanaotros(tvi.idmovimiento,tvi.iddetalle,3," + pAduana.ToString + "),spdadetalleslotes(tvi.idmovimiento,tvi.iddetalle,4," + pAduana.ToString + ")) as descripcion,round(tvi.precio,2) as precio,tblmonedas.abreviatura,concat((select nombre from tblalmacenes where tblalmacenes.idalmacen=tvi.idalmacen), ' ', u.ubicaciono) as almacen1,concat((select nombre from tblalmacenes where tblalmacenes.idalmacen=tvi.idalmacen2), ' ', u.ubicaciond) as almacen2 from tblmovimientosdetalles tvi inner join tblinventario on tvi.idinventario=tblinventario.idinventario inner join tblmonedas on tvi.idmoneda=tblmonedas.idmoneda inner join tbltiposcantidades on tblinventario.tipocontenido = tbltiposcantidades.idtipocantidad left outer join tblmovimientosubicaciones u on tvi.iddetalle=u.iddetalle where tvi.idmovimiento=" + pIdMovimiento.ToString
        Else
            Comm.CommandText = "select tvi.iddetalle,tvi.cantidad,tblinventario.clave,concat(tvi.descripcion,spdaseriesmovimiento(tvi.idinventario,tvi.idmovimiento," + pConSeries.ToString + "),spdadetallesaduanaotros(tvi.idmovimiento,tvi.iddetalle,3," + pAduana.ToString + "),spdadetalleslotes(tvi.idmovimiento,tvi.iddetalle,4," + pAduana.ToString + ")) as descripcion,round(tvi.precio,2) as precio,tblmonedas.abreviatura,concat((select nombre from tblalmacenes where tblalmacenes.idalmacen=tvi.idalmacen), ' ', u.ubicaciono) as almacen1,'' as almacen2 from tblmovimientosdetalles tvi inner join tblinventario on tvi.idinventario = tblinventario.idinventario inner join tblmonedas on tvi.idmoneda=tblmonedas.idmoneda inner join tbltiposcantidades on tblinventario.tipocontenido=tbltiposcantidades.idtipocantidad left outer join tblmovimientosubicaciones u on tvi.iddetalle=u.iddetalle where tvi.idmovimiento=" + pIdMovimiento.ToString
        End If
