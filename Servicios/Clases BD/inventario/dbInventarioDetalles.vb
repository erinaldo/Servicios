Public Class dbInventarioDetalles
    ...
    Public Sub Guardar(ByVal pIdinventario As Integer, ByVal pCantidad As Double, ByVal pIdInventariop As Integer)
        ...
        Comm.CommandText = "insert into tblinventariodetalles(idinventario,cantidad,idinventariop,idUsuarioAlta,fechaAlta,horaAlta,idUsuarioCambio,fechaCambio,horaCambio) values(" + Idinventario.ToString + "," + Cantidad.ToString + "," + IdInventariop.ToString + "," + GlobalIdUsuario.ToString() + ",'" + DateTime.Now.ToString("yyyy/MM/dd") + "','" + TimeOfDay.ToString("HH:mm:ss") + "'," + GlobalIdUsuario.ToString() + ",'" + DateTime.Now.ToString("yyyy/MM/dd") + "','" + TimeOfDay.ToString("HH:mm:ss") + "')"
    ...
    Public Sub Modificar(ByVal pID As Integer, ByVal pCantidad As Double)
        ID = pID
        Cantidad = pCantidad
        Comm.CommandText = "update tblinventariodetalles set cantidad=" + Cantidad.ToString + ", idUsuarioCambio=" + GlobalIdUsuario.ToString() + ", fechaCambio='" + DateTime.Now.ToString("yyyy/MM/dd") + "', horaCambio='" + TimeOfDay.ToString("HH:mm:ss") + "' where iddetalle=" + pID.ToString
        Comm.ExecuteNonQuery()
    End Sub
