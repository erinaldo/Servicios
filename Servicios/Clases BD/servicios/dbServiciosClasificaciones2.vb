Public Class dbServiciosClasificaciones2
    ...
    Public Sub Guardar(ByVal pNombre As String, ByVal pIdClasificacion As Integer, ByVal pPrecio As Double)
        ...
        Precio = pPrecio
        Comm.CommandText = "insert into tblserviciosclasificaciones2(nombre,idclasificacion,precio,idUsuarioAlta,fechaAlta,horaAlta,idUsuarioCambio,fechaCambio,horaCambio) values('" + Replace(Nombre, "'", "''") + "'," + IdClasificacion1.ToString + "," + Precio.ToString + "," + GlobalIdUsuario.ToString() + ",'" + DateTime.Now.ToString("yyyy/MM/dd") + "','" + TimeOfDay.ToString("HH:mm:ss") + "'," + GlobalIdUsuario.ToString() + ",'" + DateTime.Now.ToString("yyyy/MM/dd") + "','" + TimeOfDay.ToString("HH:mm:ss") + "')"
    ...
    Public Sub Modificar(ByVal pID As Integer, ByVal pNombre As String, ByVal pPrecio As Double)
        ...
        Nombre = pNombre
        Precio = pPrecio
        Comm.CommandText = "update tblserviciosclasificaciones2 set nombre='" + Replace(Nombre, "'", "''") + "',precio=" + Precio.ToString + ", idUsuarioCambio=" + GlobalIdUsuario.ToString() + ", fechaCambio='" + DateTime.Now.ToString("yyyy/MM/dd") + "', horaCambio='" + TimeOfDay.ToString("HH:mm:ss") + "' where idclasificacion2=" + ID.ToString
        Comm.ExecuteNonQuery()
    End Sub
