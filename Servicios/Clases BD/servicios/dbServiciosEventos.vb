Public Class dbServiciosEventos
    ...
    Public Sub Guardar(ByVal pIdServicio As Integer, ByVal pIdClasificacion As Integer, ByVal pIdClasificacion2 As Integer, ByVal pComentario As String, ByVal pTiempo As Double, ByVal pPrecio As Double, ByVal pidTecnico As Integer, ByVal pidEquipo As Integer, ByVal pFecha As String, ByVal pIva As Double)
        ...
        fecha = pFecha
        Comm.CommandText = "insert into tblservicioseventos(idservicio,idclasificacion,idclasificacion2,comentario,tiempo,precio,idtecnico,idEquipo, fecha,iva,idUsuarioAlta,fechaAlta,horaAlta,idUsuarioCambio,fechaCambio,horaCambio) values(" + IdServicio.ToString + "," + IdClasificacion.ToString + "," + IdClasificacion2.ToString + ",'" + Replace(Comentario, "'", "''") + "'," + Tiempo.ToString + "," + Precio.ToString + "," + IdTecnico.ToString + "," + pidEquipo.ToString + ",'" + fecha + "'," + iva.ToString() + "," + GlobalIdUsuario.ToString() + ",'" + DateTime.Now.ToString("yyyy/MM/dd") + "','" + TimeOfDay.ToString("HH:mm:ss") + "'," + GlobalIdUsuario.ToString() + ",'" + DateTime.Now.ToString("yyyy/MM/dd") + "','" + TimeOfDay.ToString("HH:mm:ss") + "')"
    ...
    Public Sub Guardarsuc(ByVal pIdServicio As Integer, ByVal pIdClasificacion As Integer, ByVal pIdClasificacion2 As Integer, ByVal pComentario As String, ByVal pTiempo As Double, ByVal pPrecio As Double, ByVal pidTecnico As Integer, ByVal pidEquipo As Integer, ByVal pFecha As String, ByVal pIva As Double)
        ...
        IdTecnico = pidTecnico
        fecha = pFecha
        Comm.CommandText = "insert into tblservicioseventossuc(idservicio,idclasificacion,idclasificacion2,comentario,tiempo,precio,idtecnico,idEquipo, fecha,iva,idUsuarioAlta,fechaAlta,horaAlta,idUsuarioCambio,fechaCambio,horaCambio) values(" + IdServicio.ToString + "," + IdClasificacion.ToString + "," + IdClasificacion2.ToString + ",'" + Replace(Comentario, "'", "''") + "'," + Tiempo.ToString + "," + Precio.ToString + "," + IdTecnico.ToString + "," + pidEquipo.ToString + ",'" + fecha + "'," + iva.ToString() + "," + GlobalIdUsuario.ToString() + ",'" + DateTime.Now.ToString("yyyy/MM/dd") + "','" + TimeOfDay.ToString("HH:mm:ss") + "'," + GlobalIdUsuario.ToString() + ",'" + DateTime.Now.ToString("yyyy/MM/dd") + "','" + TimeOfDay.ToString("HH:mm:ss") + "')"
        Comm.ExecuteNonQuery()
    ...
    Public Sub Modificar(ByVal pID As Integer, ByVal pIdClasificacion As Integer, ByVal pIdClasificacion2 As Integer, ByVal pComentario As String, ByVal pTiempo As Double, ByVal pPrecio As Double, ByVal pidTecnico As Integer, ByVal pFecha As String, ByVal pIVA As Double)
        ...
        fecha = pFecha
        iva = pIVA
        Comm.CommandText = "update tblservicioseventos set precio=" + Precio.ToString + ",idclasificacion=" + IdClasificacion.ToString + ",idclasificacion2=" + IdClasificacion2.ToString + ",comentario='" + Replace(Comentario, "'", "''") + "',tiempo=" + Tiempo.ToString + ",idtecnico=" + IdTecnico.ToString + ",fecha='" + fecha + "'" + ",iva=" + iva.ToString + ", idUsuarioCambio=" + GlobalIdUsuario.ToString() + ", fechaCambio='" + DateTime.Now.ToString("yyyy/MM/dd") + "', horaCambio='" + TimeOfDay.ToString("HH:mm:ss") + "' where idevento=" + ID.ToString
        Comm.ExecuteNonQuery()
    End Sub
    Public Sub Modificarsuc(ByVal pID As Integer, ByVal pIdClasificacion As Integer, ByVal pIdClasificacion2 As Integer, ByVal pComentario As String, ByVal pTiempo As Double, ByVal pPrecio As Double, ByVal pidTecnico As Integer, ByVal pFecha As String, ByVal pIVA As Double)
        ...
        fecha = pFecha
        iva = pIVA
        Comm.CommandText = "update tblservicioseventossuc set precio=" + Precio.ToString + ",idclasificacion=" + IdClasificacion.ToString + ",idclasificacion2=" + IdClasificacion2.ToString + ",comentario='" + Replace(Comentario, "'", "''") + "',tiempo=" + Tiempo.ToString + ",idtecnico=" + IdTecnico.ToString + ",fecha='" + fecha + "'" + ",iva=" + iva.ToString + ", idUsuarioCambio=" + GlobalIdUsuario.ToString() + ", fechaCambio='" + DateTime.Now.ToString("yyyy/MM/dd") + "', horaCambio='" + TimeOfDay.ToString("HH:mm:ss") + "' where idevento=" + ID.ToString
        Comm.ExecuteNonQuery()
    End Sub
