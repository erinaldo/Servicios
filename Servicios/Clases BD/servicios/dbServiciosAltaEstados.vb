...
Public Class dbServiciosAltaEstados
    ...
    Public Sub Guardar(ByVal pCodigo As String, ByVal pEstado As String)
        Codigo = pCodigo
        Estado = pEstado
        Comm.CommandText = "insert into tblserviciosestados(codigo,estado,idUsuarioAlta,fechaAlta,horaAlta,idUsuarioCambio,fechaCambio,horaCambio) values('" + Replace(Codigo, "'", "''") + "','" + Replace(Estado, "'", "''") + "'," + GlobalIdUsuario.ToString() + ",'" + DateTime.Now.ToString("yyyy/MM/dd") + "','" + TimeOfDay.ToString("HH:mm:ss") + "'," + GlobalIdUsuario.ToString() + ",'" + DateTime.Now.ToString("yyyy/MM/dd") + "','" + TimeOfDay.ToString("HH:mm:ss") + "')"
    ...
    Public Sub Modificar(ByVal pID As Integer, ByVal pCodigo As String, ByVal pNombre As String)
        ...
        Estado = pNombre
        Codigo = pCodigo
        Comm.CommandText = "update tblserviciosestados set codigo='" + Replace(Codigo, "'", "''") + "',estado='" + Replace(Estado, "'", "''") + "', idUsuarioCambio=" + GlobalIdUsuario.ToString() + ", fechaCambio='" + DateTime.Now.ToString("yyyy/MM/dd") + "', horaCambio='" + TimeOfDay.ToString("HH:mm:ss") + "' where idEstado=" + ID.ToString()
        Comm.ExecuteNonQuery()
    End Sub
