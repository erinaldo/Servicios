Public Class dbServicios
    ...
    Public Sub Guardar(ByVal pDetalles As String, ByVal pFechaEntrada As String, ByVal pHoraEntrada As String, ByVal pFechaSalida As String, ByVal pHoraSalida As String, ByVal pEstado As Byte, ByVal pIdCliente As Integer, ByVal pPrecio As Double, ByVal pFolio As Integer, ByVal pIdEquipo As Integer, ByVal pidTecnico As Integer)
        ...
        Cerrado = 0
        Comm.CommandText = "insert into tblservicios(detalles,fechae,horae,fechas,horas,estado,idcliente,precio,folio,cerrado,idEquipo,serie,idtecnico,idUsuarioAlta,fechaAlta,horaAlta,idUsuarioCambio,fechaCambio,horaCambio) values('" + Replace(Detalles, "'", "''") + "','" + FechaEntrada + "','" + HoraEntrada + "','" + FechaSalida + "','" + HoraSalida + "'," + Estado.ToString + "," + IdCliente.ToString + "," + Precio.ToString + "," + Folio.ToString + ",0" + "," + pIdEquipo.ToString + ",''," + IdTecnico.ToString + "," + GlobalIdUsuario.ToString() + ",'" + DateTime.Now.ToString("yyyy/MM/dd") + "','" + TimeOfDay.ToString("HH:mm:ss") + "'," + GlobalIdUsuario.ToString() + ",'" + DateTime.Now.ToString("yyyy/MM/dd") + "','" + TimeOfDay.ToString("HH:mm:ss") + "')"
    ...
    Public Sub Modificar(ByVal pID As Integer, ByVal pDetalles As String, ByVal pFechaSalida As String, ByVal pHoraSalida As String, ByVal pEstado As Byte, ByVal pPrecio As Double, ByVal pCerrado As Byte, ByVal pSerie As String, ByVal pFolio As Integer, ByVal pIdTecnico As Integer)
        ...
        Serie = pSerie
        IdTecnico = pIdTecnico
        Comm.CommandText = "update tblservicios set precio=" + Precio.ToString + ",detalles='" + Replace(Detalles, "'", "''") + "',fechas='" + FechaSalida + "',horas='" + HoraSalida + "',estado=" + Estado.ToString + ",cerrado=" + Cerrado.ToString + " ,Serie='" + pSerie + "', Folio=" + Folio.ToString() + ",idtecnico=" + pIdTecnico.ToString + ", idUsuarioCambio=" + GlobalIdUsuario.ToString() + ", fechaCambio='" + DateTime.Now.ToString("yyyy/MM/dd") + "', horaCambio='" + TimeOfDay.ToString("HH:mm:ss") + "' where idservicio=" + ID.ToString
        Comm.ExecuteNonQuery()
    End Sub
    Public Sub ModificarSuc(ByVal pID As Integer, ByVal pDetalles As String, ByVal pFechaSalida As String, ByVal pHoraSalida As String, ByVal pEstado As Byte, ByVal pPrecio As Double, ByVal pCerrado As Byte, ByVal pSerie As String, ByVal pFolio As Integer, ByVal pIdTecnico As Integer)
        ...
        Serie = pSerie
        IdTecnico = pIdTecnico
        Comm.CommandText = "update tblserviciossuc set precio=" + Precio.ToString + ",detalles='" + Replace(Detalles, "'", "''") + "',fechas='" + FechaSalida + "',horas='" + HoraSalida + "',estado=" + Estado.ToString + ",cerrado=" + Cerrado.ToString + " ,Serie='" + pSerie + "', Folio=" + Folio.ToString() + ",idtecnico=" + IdTecnico.ToString + ", idUsuarioCambio=" + GlobalIdUsuario.ToString() + ", fechaCambio='" + DateTime.Now.ToString("yyyy/MM/dd") + "', horaCambio='" + TimeOfDay.ToString("HH:mm:ss") + "' where idservicio=" + ID.ToString
        Comm.ExecuteNonQuery()
    End Sub
    ...
    Public Function ConsultaEspecifica(ByVal Fecha1 As String, ByVal Fecha2 As String, Optional ByVal nombreFolio As String = "", Optional ByVal estado As Integer = 100, Optional ByVal cerrado As Integer = 100) As DataView
        ...
        Else
            ...
            End If
        End If
        Comm.CommandText += " order by fechae desc,folio desc"
