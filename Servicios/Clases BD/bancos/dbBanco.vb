...
Public Class dbBanco
    ...
    Public Sub Modificar(ByVal pID As Integer, ByVal pCodigo As String, ByVal pNombre As String)
        ...
        Nombre = pNombre
        Codigo = pCodigo
        Comm.CommandText = "update tblbancos set codigo='" + Replace(Codigo, "'", "''") + "',Nombre='" + Replace(Nombre, "'", "''") + "', idUsuarioCambio=" + GlobalIdUsuario.ToString() + ", fechaCambio='" + DateTime.Now.ToString("yyyy/MM/dd") + "', horaCambio='" + TimeOfDay.ToString("HH:mm:ss") + "' where idBanco=" + ID.ToString()
        Comm.ExecuteNonQuery()
    End Sub
