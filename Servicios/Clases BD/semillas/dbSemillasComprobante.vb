...
#End Region
    ...
    Public Sub agregar(ByVal comprobante As dbSemillasComprobante)
        comm.CommandText = "insert into tblsemillascomprobante(idlciente,riego,superficie,idCompra,numcomprobante,disponecontrato,sociopersonamoral,volumen,estado,sucursal,folio,serie,nombreRepresentante,apellidoP,apellidoM,fecha,idUsuarioAlta,fechaAlta,horaAlta,idUsuarioCambio,fechaCambio,horaCambio) " +
            "values(" + comprobante.idCliente.ToString() + "," +
                    ...
                    "'" + comprobante.apellidoM + "','" + comprobante.Fecha + "'," + GlobalIdUsuario.ToString() + ",'" + DateTime.Now.ToString("yyyy/MM/dd") + "','" + TimeOfDay.ToString("HH:mm:ss") + "'," + GlobalIdUsuario.ToString() + ",'" + DateTime.Now.ToString("yyyy/MM/dd") + "','" + TimeOfDay.ToString("HH:mm:ss") + "');"
        Try
    ...
    Public Sub actualiza(ByVal comprobante As dbSemillasComprobante)
        comm.CommandText = "update tblsemillascomprobante set idcliente=" + comprobante.idCliente.ToString() + "," +
            ...
            ", idUsuarioCambio=" + GlobalIdUsuario.ToString() + ", fechaCambio='" + DateTime.Now.ToString("yyyy/MM/dd") + "', horaCambio='" + TimeOfDay.ToString("HH:mm:ss") + "' where id=" + comprobante.id.ToString() + ";"
        Try
            comm.ExecuteNonQuery()
        Catch ex As Exception
    ...
    Public Sub eliminaSinGuardar()
        comm.CommandText = "delete from tblsemillascomprobante where estado=" + CInt(Estados.Inicio).ToString() + ";"
        comm.ExecuteNonQuery()
    End Sub
    ...
    Public Function crearComprobante() As Integer
        comm.CommandText = "insert into tblsemillascomprobante(idcliente,riego,superficie,idcompra,numcomprobante,disponecontrato,sociopersonamoral,volumen,estado,sucursal,folio,serie,fecha,idUsuarioAlta,fechaAlta,horaAlta,idUsuarioCambio,fechaCambio,horaCambio) values(null,null,null,null,null,null,null,null,0,null,null,null,'" + Date.Now.ToString("yyyy/MM/dd") + "'," + GlobalIdUsuario.ToString() + ",'" + DateTime.Now.ToString("yyyy/MM/dd") + "','" + TimeOfDay.ToString("HH:mm:ss") + "'," + GlobalIdUsuario.ToString() + ",'" + DateTime.Now.ToString("yyyy/MM/dd") + "','" + TimeOfDay.ToString("HH:mm:ss") + "');"
        comm.ExecuteNonQuery()
    ...
    Public Function buscarCliente(ByVal clave As String, pFecha1 As String, pFecha2 As String, pFolio As String) As DataView
        ...
        End If
        comm.CommandText += " order by d.fecha desc,d.numcomprobante desc"
        Dim da As New MySqlDataAdapter(comm)
        da.Fill(ds, "detalles")
        Return ds.Tables("detalles").DefaultView
    End Function
