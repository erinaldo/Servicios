...
#End Region
    ...
    Public Sub agregar(ByVal anticipo As dbAnticipos)
        comm.CommandText = "insert into tblsemillasanticipos(medio,importe,idLiquidacion,guardado,idUsuarioAlta,fechaAlta,horaAlta,idUsuarioCambio,fechaCambio,horaCambio) values(" +
            "'" + anticipo.medio + "'," + anticipo.importe.ToString() + "," + anticipo.liquidacion.id.ToString() + ",false," + GlobalIdUsuario.ToString() + ",'" + DateTime.Now.ToString("yyyy/MM/dd") + "','" + TimeOfDay.ToString("HH:mm:ss") + "'," + GlobalIdUsuario.ToString() + ",'" + DateTime.Now.ToString("yyyy/MM/dd") + "','" + TimeOfDay.ToString("HH:mm:ss") + "');"
