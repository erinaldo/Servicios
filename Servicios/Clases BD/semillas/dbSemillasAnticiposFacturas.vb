...
Public Class dbSemillasAnticiposFacturas
    ...
    Public Sub agregar(ByVal factura As dbSemillasAnticiposFacturas)
        comm.CommandText = "insert into tblsemillasanticiposfacturas(idliquidacion,idfactura,importe,guardado,idUsuarioAlta,fechaAlta,horaAlta,idUsuarioCambio,fechaCambio,horaCambio) values" +
            "(" + factura.idLiquidacion.ToString() + "," + factura.idVenta.ToString() + "," + factura.importe.ToString() + "," + factura.guardado.ToString() + "," + GlobalIdUsuario.ToString() + ",'" + DateTime.Now.ToString("yyyy/MM/dd") + "','" + TimeOfDay.ToString("HH:mm:ss") + "'," + GlobalIdUsuario.ToString() + ",'" + DateTime.Now.ToString("yyyy/MM/dd") + "','" + TimeOfDay.ToString("HH:mm:ss") + "');"
