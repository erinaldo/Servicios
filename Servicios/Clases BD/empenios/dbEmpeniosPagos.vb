Public Class dbEmpeniosPagos
    ...
    Public Sub GuardarPago(ByVal pIdEmpenio As Integer, ByVal pFecha As String, ByVal pCantidad As Double, ByVal pTotalG As Double, ByVal pRefrengoG As Double, ByVal pTipo As Integer, ByVal pCaja As Integer, ByVal pIDMovimiento As Integer, ByVal pDescuento As Integer)
        ...
        Fecha = pFecha
        Cantidad = pCantidad
        Comm.CommandText = "insert into tblempeniosabono(idEmpenio, fecha, cantidad,habilitado,totalEmepnio,totalRefrendo,tipoPago,caja, idMovimiento,descuento,hora,vis,folio,idUsuarioAlta,fechaAlta,horaAlta,idUsuarioCambio,fechaCambio,horaCambio) values(" + idEmpenio.ToString + " , '" + Replace(Fecha, "'", "''") + "', " + Cantidad.ToString + ",0," + pTotalG.ToString + "," + pRefrengoG.ToString + "," + pTipo.ToString + "," + pCaja.ToString + "," + pIDMovimiento.ToString + "," + pDescuento.ToString + ",'" + Date.Now.ToString("HH:mm:ss") + "',1,0," + GlobalIdUsuario.ToString() + ",'" + DateTime.Now.ToString("yyyy/MM/dd") + "','" + TimeOfDay.ToString("HH:mm:ss") + "'," + GlobalIdUsuario.ToString() + ",'" + DateTime.Now.ToString("yyyy/MM/dd") + "','" + TimeOfDay.ToString("HH:mm:ss") + "');"
        Comm.ExecuteNonQuery()
    End Sub
    Public Sub ModificarPago(ByVal pIdPago As Integer, ByVal pIdEmpenio As Integer, ByVal pFecha As String, ByVal pCantidad As Double, ByVal pDescuento As Integer)
        ...
        Fecha = pFecha
        Cantidad = pCantidad
        Comm.CommandText = "update tblempeniosabono set fecha='" + Replace(pFecha, "'", "''") + "', cantidad=" + Cantidad.ToString + ", descuento=" + pDescuento.ToString + ", idUsuariCambio=" + GlobalIdUsuario.ToString() + ", fechaCambio='" + DateTime.Now.ToString("yyyy/MM/dd") + "', horaCambio='" + TimeOfDay.ToString("HH:mm:ss") + "' where idAbono=" + idPago.ToString
        Comm.ExecuteScalar()
    End Sub
