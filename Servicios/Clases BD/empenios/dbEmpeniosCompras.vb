...
Public Class dbEmpeniosCompras
    ...
    Public Sub Guardar(ByVal pIdCliente As Integer, ByVal pFecha As String, ByVal pFolio As Integer, ByVal pTotal As Double, ByVal pidSucursal As Integer, ByVal pSerie As String, ByVal pidCaja As Integer, ByVal pIdVendedor As Integer, ByVal pTipo As Byte, ByVal pComentario As String, ByVal pDiasPrestamos As Integer, ByVal Pidforma As Integer, ByVal ptipoEmpenio As Integer)
        ...
        Comm.CommandText = "insert into tblempenioscompras(fecha,folio,hora,estado,total,idsucursal,serie,idcaja,idvendedor,comentario,tipo,idcliente,idforma,tipoEmpenio,idUsuarioAlta,fechaAlta,horaAlta,idUsuarioCambio,fechaCambio,horaCambio) values('" + Replace(Fecha, "'", "''") + "','" + Folio.ToString + "','" + Format(TimeOfDay, "HH:mm:ss") + "'," + CStr(Estados.SinGuardar) + "," + Total.ToString() + "," + IdSucursal.ToString + ",'" + Replace(Trim(Serie), "'", "''") + "'," + IdCaja.ToString + "," + IdVendedor.ToString + ",'" + Replace(Comentario, "'", "''") + "'," + Tipo.ToString + "," + idCliente.ToString + ",0," + tipoEmpenio.ToString + "," + GlobalIdUsuario.ToString() + ",'" + DateTime.Now.ToString("yyyy/MM/dd") + "','" + TimeOfDay.ToString("HH:mm:ss") + "'," + GlobalIdUsuario.ToString() + ",'" + DateTime.Now.ToString("yyyy/MM/dd") + "','" + TimeOfDay.ToString("HH:mm:ss") + "');"
    ...
    Public Sub Modificar(ByVal pID As Integer, ByVal pIdCliente As Integer, ByVal pFecha As String, ByVal pFolio As Integer, ByVal pTotal As Double, ByVal pidSucursal As Integer, ByVal pSerie As String, ByVal pidCaja As Integer, ByVal pIdVendedor As Integer, ByVal pTipo As Byte, ByVal pComentario As String, ByVal pDiasPrestamos As Integer, ByVal Pidforma As Integer, ByVal ptipoEmpenio As Integer, ByVal pEstado As Integer)
        ...
        idCliente = pIdCliente
        tipoEmpenio = ptipoEmpenio
        Comm.CommandText = "update tblempenioscompras set fecha='" + Replace(Fecha, "'", "''") + "',folio='" + Folio.ToString + "',estado=" + Estado.ToString + ",total=" + Total.ToString + ",serie='" + Replace(Trim(Serie), "'", "''") + "',idvendedor=" + IdVendedor.ToString + ",comentario='" + Replace(Comentario, "'", "''") + "',tipo=" + Tipo.ToString + ",idcaja=" + IdCaja.ToString + ",idcliente=" + idCliente.ToString + ",idforma=" + Pidforma.ToString + ", tipoEmpenio=" + tipoEmpenio.ToString + ", estado=" + pEstado.ToString + ", idUsuarioCambio=" + GlobalIdUsuario.ToString() + ", fechaCambio='" + DateTime.Now.ToString("yyyy/MM/dd") + "', horaCambio='" + TimeOfDay.ToString("HH:mm:ss") + "' where idmovimiento=" + Idmovimiento.ToString
        Comm.ExecuteNonQuery()
    End Sub
