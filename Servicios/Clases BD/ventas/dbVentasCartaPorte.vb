Public Class dbVentasCartaPorte
    ...
    Public Sub Guardar(ByVal pOrigen As String, ByVal pDestino As String, ByVal pChofer As String, ByVal pMatricula As String, ByVal pMercancia As String, ByVal pPeso As String, ByVal pFecha As String, ByVal pidVenta As Integer, ByVal pVUnitario As String, ByVal pVDeclarado As String, ByVal pReferencia As String, ByVal pPedimento As String, ByVal pFechaPedimento As String)
        Comm.CommandText = "insert into tblventascartaporte(origen,destino,chofer,matricula,mercancia,peso,fecha,idventa,valorunitario,valordeclarado,referencia,pedimento,fechapedimento,idUsuarioAlta,fechaAlta,horaAlta,idUsuarioCambio,fechaCambio,horaCambio) values('" + Replace(pOrigen, "'", "''") + "','" + Replace(pDestino, "'", "''") + "','" + Replace(pChofer, "'", "''") + "','" + Replace(pMatricula, "'", "''") + "','" + Replace(pMercancia, "'", "''") + "','" + Replace(pPeso, "'", "''") + "','" + pFecha + "'," + pidVenta.ToString + ",'" + Replace(pVUnitario, "'", "''") + "','" + Replace(pVDeclarado, "'", "''") + "','" + Replace(pReferencia, "'", "''") + "','" + Replace(pPedimento, "'", "''") + "','" + Replace(pFechaPedimento, "'", "''") + "'," + GlobalIdUsuario.ToString() + ",'" + DateTime.Now.ToString("yyyy/MM/dd") + "','" + TimeOfDay.ToString("HH:mm:ss") + "'," + GlobalIdUsuario.ToString() + ",'" + DateTime.Now.ToString("yyyy/MM/dd") + "','" + TimeOfDay.ToString("HH:mm:ss") + "');"
