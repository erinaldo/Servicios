Public Class dbClientes
    ...
    Public IdFormaF As Integer
    Public IdFormaR As Integer
    Public NoChecarCr As Byte
    ...
    Public Sub Guardar(ByVal pNombre As String, ByVal pDireccion As String, ByVal pTelefono As String, ByVal pEmail As String, ByVal pContacto As String, ByVal pClave As String, ByVal pRFC As String, ByVal pGiro As String, ByVal pCiudad As String, ByVal pCP As String, ByVal pEstado As String, ByVal pPais As String, ByVal pDireccion2 As String, ByVal pCiudad2 As String, ByVal pCP2 As String, ByVal pEstado2 As String, ByVal pPais2 As String, ByVal pNoexterior As String, ByVal pNoInterior As String, ByVal pColonia As String, ByVal pMunicipio As String, ByVal pReferenciaDomicilio As String, ByVal pNoexterior2 As String, ByVal pNoInterior2 As String, ByVal pColonia2 As String, ByVal pMunicipio2 As String, ByVal pReferenciaDomicilio2 As String, ByVal pDireccionFiscal As Byte, ByVal pCredito As Double, ByVal pCreditoDias As Double, ByVal pSaldo As Double, ByVal pisr As Double, ByVal pIvaRetenido As Double, ByVal pIdVendedor As Integer, ByVal pIdLista As Integer, ByVal pCurp As String, ByVal pSobreescribeIVA As Byte, ByVal pIVA As Double, ByVal pEscondeIva As Byte, ByVal pRepresentante As String, ByVal pRepresentanteRFC As String, ByVal pRepresentanteRegistro As String, ByVal pUsaAddenda As Integer, ByVal pActivarImpuestos As Byte, ByVal pZona As Integer, ByVal pZona2 As Integer, ByVal pImagen As String, ByVal pIdentificacion As Integer, ByVal pNumeroID As String, pIdCuenta As Integer, pIdTipo As Integer, pIdCuenta2 As Integer, pIdCuenta3 As Integer, pIdCuenta4 As Integer, pIdFormaF As Integer, pIdformaR As Integer, pNoChecarCr As Byte, pClaveColonia As String, pClavelocalidad As String, pClaveMunicipio As String, pClaveEstado As String, pClavePais As String, pRegIdTRib As String, pUsoCFDI As String)
        ...
        Estado = pEstado.Trim
        Pais = pPais.Trim
        Direccion2 = pDireccion2.Trim
        Ciudad2 = pCiudad2.Trim
        CP2 = pCP2.Trim
        Estado2 = pEstado2.Trim
        Pais2 = pPais2.Trim
        ...
        IdCuenta = pIdCuenta
        IdTipo = pIdTipo
        IdCuenta2 = pIdCuenta2
        IdCuenta3 = pIdCuenta3
        idCuenta4 = pIdCuenta4
        IdFormaF = pIdFormaF
        IdFormaR = pIdformaR
        ...
        "," + IdCuenta2.ToString + "," + IdCuenta3.ToString + "," + idCuenta4.ToString + "," + IdFormaF.ToString + "," + IdFormaR.ToString + "," + pNoChecarCr.ToString +
        ",'" + pClaveColonia + "','" + pClavelocalidad + "','" + pClaveMunicipio + "','" + pClaveEstado + "','" + pClavePais + "','" + Replace(pRegIdTRib, "'", "''") + "','" + pUsoCFDI + "')"
    ...
    Public Sub Modificar(ByVal pID As Integer, ByVal pNombre As String, ByVal pDireccion As String, ByVal pTelefono As String, ByVal pEmail As String, ByVal pContacto As String, ByVal pClave As String, ByVal pRFC As String, ByVal pGiro As String, ByVal pCiudad As String, ByVal pCP As String, ByVal pEstado As String, ByVal pPais As String, ByVal pDireccion2 As String, ByVal pCiudad2 As String, ByVal pCP2 As String, ByVal pEstado2 As String, ByVal pPais2 As String, ByVal pNoexterior As String, ByVal pNoInterior As String, ByVal pColonia As String, ByVal pMunicipio As String, ByVal pReferenciaDomicilio As String, ByVal pNoexterior2 As String, ByVal pNoInterior2 As String, ByVal pColonia2 As String, ByVal pMunicipio2 As String, ByVal pReferenciaDomicilio2 As String, ByVal pDireccionFiscal As Byte, ByVal pCredito As Double, ByVal pCreditoDias As Double, ByVal pISR As Double, ByVal pIvaRetenido As Double, ByVal pIdVendedor As Integer, ByVal pidlista As Integer, ByVal pCurp As String, ByVal pSobreescribeIVA As Byte, ByVal pIVA As Double, ByVal pEscondeiva As Byte, ByVal pRepresentante As String, ByVal pRepresentanteRFC As String, ByVal pRepresentanteRegistro As String, ByVal pUsaAdenda As Integer, ByVal pActivarImpuestos As Byte, ByVal pZona As Integer, ByVal pZona2 As Integer, ByVal pImagen As String, ByVal pIdentificacion As Integer, ByVal pNumeroID As String, pIdCuenta As Integer, pIdTipo As Integer, pIdCuenta2 As Integer, pIdCuenta3 As Integer, pIdCuenta4 As Integer, pidFormaF As Integer, pIdFormaR As Integer, pNoChecarCr As Byte, pClaveColonia As String, pClavelocalidad As String, pClaveMunicipio As String, pClaveEstado As String, pClavePais As String, pRegidTrib As String, pUsoCFDI As String)
        ...
        ",representante='" + Replace(Representante, "'", "''") + "',representanterfc='" + Replace(RepresentanteRFC, "'", "''") + "',representanteregistro='" + Replace(RepresentanteRegistro, "'", "''") + "',usaadenda=" + UsaAdenda.ToString + ",activarimpuestos=" + ActivarImpuestos.ToString + " , zona=" + zona.ToString + ",zona2=" + zona2.ToString + ", imagen='" + Replace(imagen.ToString, "\", "\\") + "',idcuenta=" + IdCuenta.ToString + ",idtipo=" + pIdTipo.ToString + ", fechaCambio='" + Date.Now.ToString("yyyy/MM/dd") + "', horaCambio='" + TimeOfDay.ToString("HH:mm:ss") + "', idUsuario=" + GlobalIdUsuario.ToString() + _
        ",idcuenta2=" + IdCuenta2.ToString + ",idcuenta3=" + IdCuenta3.ToString + ",idcuenta4=" + idCuenta4.ToString + ",idformaf=" + IdFormaF.ToString + ",idformar=" + IdFormaR.ToString + ",nochecarcr=" + pNoChecarCr.ToString + _
        ",clavecolonia='" + pClaveColonia + "',clavelocalidad='" + pClavelocalidad + "',clavemun='" + pClaveMunicipio + "',claveestado='" + pClaveEstado + "',clavepais='" + pClavePais + "',regidtrib='" + Replace(pRegidTrib, "'", "''") + "',usocfdi='" + pUsoCFDI + "'" + _
    ...
    Public Function Consulta(Optional ByVal pNombre As String = "") As DataView
        ...
        Comm.CommandText = "select idcliente,clave,nombre,rfc from tblclientes where concat(clave,rfc,nombre,telefono) like '%" + Replace(pNombre, "'", "''") + "%'"
    ...
    Public Function TieneCreditoporFecha(pidCliente As Integer, pDiasCredito As Integer) As Boolean
        ...
        Comm.CommandText = "select ifnull((select min(fecha) from tblventas inner join tblformasdepago on tblventas.idforma=tblformasdepago.idforma where estado=3 and round(totalapagar,2)-round(credito,2)>0.99 and tblformasdepago.tipo=0 and tblventas.idcliente=" + pidCliente.ToString + "),'2100/01/01')"
        Fmin = Comm.ExecuteScalar
        Comm.CommandText = "select ifnull((select min(fecha) from tblventasremisiones inner join tblformasdepagoremisiones on tblventasremisiones.idforma=tblformasdepagoremisiones.idforma where round(totalapagar,2)-round(credito,2)>0.99 and tblformasdepagoremisiones.tipo=3 and tblventasremisiones.idcliente=" + pidCliente.ToString + " and estado=3),'2100/01/01')"
    ...
    Public Function ReporteAnalitico(ByVal PidCliente As Integer, ByVal pFecha1 As String, ByVal pFecha2 As String, pIdtipo As Integer) As DataView
        Dim DS As New DataSet
        ...
        " from tblclientes"
        If PidCliente <> 0 Then Comm.CommandText += " where tblclientes.idcliente=" + PidCliente.ToString
    ...
    End Function
    Public Function ReporteAnaliticoRem(ByVal PidCliente As String, ByVal pFecha1 As String, ByVal pFecha2 As String, pIdTipo As Integer) As DataView
        Dim DS As New DataSet
        ...
        " from tblclientes"
        If PidCliente <> "0" Then
            Comm.CommandText += " where tblclientes.idcliente=" + PidCliente
        Else
            If pIdTipo > 0 Then
                Comm.CommandText += " where tblclientes.idtipo=" + pIdTipo.ToString
            End If
        End If
            Comm.CommandText += " order by tblclientes.nombre"
            Dim DA As New MySql.Data.MySqlClient.MySqlDataAdapter(Comm)
    ...
    Public Function BuscaClienteporRFC(ByVal pClave As String) As Boolean
        Dim Encontro As Integer
        Comm.CommandText = " select ifnull((select idcliente from tblclientes where rfc='" + Replace(pClave, "'", "''") + "' order by clave limit 1),0)"
        Encontro = Comm.ExecuteScalar
        If Encontro = 0 Then
            Return False
        Else
    ...
    Private Sub LlenaDatos()
        ...
        If DReader.Read() Then
            ...
            IdFormaF = DReader("idformaf")
            IdFormaR = DReader("idformar")
            NoChecarCr = DReader("nochecarcr")
            ...
            RegIdTrib = DReader("regidtrib")
            UsoCFDI = DReader("usocfdi")
    ...
    End Function
    '******************
    Public Function Reporte2(ByVal pZona As Integer, ByVal pClave As String, pSoloConCrédito As Boolean) As DataView
        Dim DS As New DataSet
        If pZona > 0 Then
            Comm.CommandText = "select * from tblclientes where zona= '" + pZona.ToString() + "' or zona2='" + pZona.ToString() + "' and clave like '%" + Replace(pClave, "'", "''") + "%' "
        Else
            Comm.CommandText = "select * from tblclientes where clave like '%" + Replace(pClave, "'", "''") + "%' "
        End If
        If pSoloConCrédito Then
            Comm.CommandText += " and (creditodias>0 or credito>0)"
        End If
    ...
    Public Function ReporteSaldoaFavor(ByVal PidCliente As Integer, ByVal pFecha1 As String, ByVal pFecha2 As String, pIdTipo As Integer) As DataView
        Dim DS As New DataSet
        ...
        Comm.ExecuteNonQuery()
        If pIdTipo > 0 Then
            Comm.CommandText = "select tblrepsaldoafavor.idcliente,tblrepsaldoafavor.fecha,tblrepsaldoafavor.serie,tblrepsaldoafavor.folio,tblrepsaldoafavor.nombrec,tblrepsaldoafavor.clave,tblrepsaldoafavor.precio,tblrepsaldoafavor.iva,tblrepsaldoafavor.tipo,tblrepsaldoafavor.cantidad,tblrepsaldoafavor.saldoant from tblrepsaldoafavor inner join tblclientes on tblrepsaldoafavor.idcliente=tblclientes.idcliente where tblclientes.idtipo=" + pIdTipo.ToString + " order by idcliente"
        Else
