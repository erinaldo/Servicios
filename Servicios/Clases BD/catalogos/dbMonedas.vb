Public Class dbMonedas
    ...
    Public Sub Modificar(ByVal pID As Integer, ByVal pNombre As String, ByVal pAbreviatura As String)
        ...
        Nombre = pNombre
        Abreviatura = pAbreviatura
        Comm.CommandText = "update tblmonedas set nombre='" + Replace(Nombre, "'", "''") + "',abreviatura='" + Replace(Abreviatura, "'", "''") + "', idUsuarioCambio=" + GlobalIdUsuario.ToString() + ", fechaCambio='" + DateTime.Now.ToString("yyyy/MM/dd") + "', horaCambio='" + TimeOfDay.ToString("HH:mm:ss") + "' where idmoneda=" + ID.ToString
        Comm.ExecuteNonQuery()
    End Sub
