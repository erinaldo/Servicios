Public Class dbDepartamentos
    ...
    Public Sub Modificar(ByVal pID As Integer, ByVal pNombre As String, ByVal pCodido As String)
        ...
        Nombre = pNombre
        Codigo = pCodido
        Comm.CommandText = "update " + Tabla + " set nombre='" + Replace(Nombre, "'", "''") + "',codigo='" + Replace(Codigo, "'", "''") + "', idUsuarioCambio=" + GlobalIdUsuario.ToString() + ", fechaCambio='" + DateTime.Now.ToString("yyyy/MM/dd") + "', horaCambio='" + TimeOfDay.ToString("HH:mm:ss") + "' where iddepartamento=" + ID.ToString
        Comm.ExecuteNonQuery()
    End Sub
