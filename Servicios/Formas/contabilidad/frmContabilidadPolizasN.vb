Public Class frmContabilidadPolizasN
    ...
    Private Sub ConsultaDetalles()
        ...
        If dgvCuentas.RowCount > dgvCuentas.DisplayedRowCount(False) Then dgvCuentas.FirstDisplayedScrollingRowIndex = dgvCuentas.RowCount - dgvCuentas.DisplayedRowCount(False)
