Public Class frmEmpeniosGastosConsulta
    ...
    Public Sub New(ByVal pModo As Integer)
        ...
        Modo = pModo
    End Sub
    Private Sub frmEmpeniosGastosConsulta_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.Icon = GlobalIcono
    ...
    Private Sub AbreDetalles()
        If IdCompra <> 0 Then
            If Modo = ModosDeBusqueda.Principal Then
                Dim F As New frmEmpeniosCompras(DGServicios.Item(0, DGServicios.CurrentCell.RowIndex).Value, 0, 0, 0, "", -1, False)
                F.ShowDialog()
            Else
    ...
    Private Sub Consulta()
        Try
            If ConsultaOn Then
                ...
                End Select
                Dim S As New dbEmpeniosCompras(MySqlcon)
