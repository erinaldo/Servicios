Public Class frmConsultaUbicaciones
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        If cmbAlmacen.SelectedIndex = -1 Then
            r.SetDataSource(db.ConsultaInventarioPorUbicacion(idsucursal, 0, idarticulo, txtUbicacion.Text, txtTarima.Text))
            ...
            f.Show()
        Else
            r.SetDataSource(db.ConsultaInventarioPorUbicacion(idsucursal, cmbAlmacen.SelectedValue, idarticulo, txtUbicacion.Text, txtTarima.Text))
            r.SetParameterValue("Encabezado", GlobalNombreEmpresa)
