...
Public Class frmInventarioImpresionCodigo
    ...
    Dim Gimpresora As String
    Private Sub frmInventarioImpresionCodigo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            Me.Icon = GlobalIcono
    ...
    Public Sub New(ByVal pCodigo As String, ByVal pIdInventario As Integer, ByVal data As Object)
    ...
    End Sub
    Public Sub New(ByVal pCodigo As String, ByVal pIdInventario As Integer, ByVal pPrecio As Double, ByVal pCopias As Integer, pImpresora As String)
    ...
    Private Sub configuraGrid()
        ...
        DataGridView1.Columns(1).HeaderText = "Lista"
    ...
    Private Sub DibujaPaginaN(ByRef e As System.Drawing.Graphics)
        ...
        Else
            ImpDb.DaZonaDetalles(TiposDocumentos.CodigoBarras + 1000, GlobalIdSucursalDefault)
        End If
        If TipoImpresora = 0 Then
    ...
    Private Sub Imprimir()
        ...
        If Gimpresora = "" Then
            ...
            End If
        Else
            Impresora = Gimpresora
        End If
        If Impresora <> "" Then
            Dim TipoImpresora As String
            TipoImpresora = 0
            PrintDocument1.DocumentName = "código de barras"
            PrintDocument1.PrinterSettings.PrinterName = Impresora
            LlenaNodosImpresion()
            If TipoImpresora = 0 Then
                LlenaNodos(suc.ID, TiposDocumentos.CodigoBarras)
            Else
                LlenaNodos(suc.ID, TiposDocumentos.CodigoBarras + 1000)
            End If
