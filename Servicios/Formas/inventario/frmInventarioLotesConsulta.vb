Public Class frmInventarioLotesConsulta
    Dim Lote As dblotes
    ...
    Private Sub frmInventarioLotesConsulta_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        End Try
        Lote = New dblotes(MySqlcon)
        Lote.IdInventario = Idinvetario
        ConsultaLotes()
    End Sub
   Private Sub ConsultaLotes()
        Try
            ...
            DataGridView2.DataSource = Lote.ConsultaLotes(Lote.IdInventario, "", False, 0)
        ...
        End Try
    End Sub
    Private Sub ConsultaMovimientosLote()
        Try
            Dim PrimerCeldaRow As Integer = -1
            'If ConsultaOn Then
            If DataGridView1.RowCount > 0 Then PrimerCeldaRow = DataGridView1.FirstDisplayedCell.RowIndex
            'Dim P As New dblotes(MySqlcon)
            DataGridView1.DataSource = Lote.ConsultaMovimientosLotes(Lote.Idlote)
    ...
    Private Sub DataGridView2_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView2.CellClick
        If e.RowIndex >= 0 Then
            Lote.Idlote = DataGridView2.Item(0, DataGridView2.CurrentCell.RowIndex).Value
            ConsultaMovimientosLote()
        End If
    End Sub
