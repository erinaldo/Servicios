Public Class frmComprasPedidosConsulta
    ...
    Private Sub Consulta()
        Try
            If ConsultaOn Then
                ...
                End Select
                DGServicios.DataSource = S.Consulta(Format(dtpFecha1.Value, "yyyy/MM/dd"), Format(dtpFecha2.Value, "yyyy/MM/dd"), txtCliente.Text, Estado, txtFolio.Text, idSSucursales.Valor(ComboBox3.SelectedIndex), False)
    ...
    Private Sub AbreDetalles()
        If IdPedidos <> 0 Then
            If Modo = ModosDeBusqueda.Principal Then
                Dim F As New frmComprasPedidos(DGServicios.Item(0, DGServicios.CurrentCell.RowIndex).Value)
                F.ShowDialog()
            Else
