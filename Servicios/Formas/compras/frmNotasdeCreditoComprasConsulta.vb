Public Class frmNotasdeCreditoComprasConsulta
    ...
    Private Sub Consulta()
        Try
            If ConsultaOn Then
                ...
                Dim S As New dbNotasdeCreditoCompras(MySqlcon)
                ...
                DGServicios.Columns(5).HeaderText = "Total"
                DGServicios.Columns(6).HeaderText = "Aplicado"
    ...
    Private Sub AbreDetalles()
        If IdVenta <> 0 Then
            If Modo = ModosDeBusqueda.Principal Then
                Dim F As New frmNotasdeCreditoCompras(DGServicios.Item(0, DGServicios.CurrentCell.RowIndex).Value)
                F.ShowDialog()
            Else
