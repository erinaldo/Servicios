Public Class frmNotasdeCredito
    ...
    Dim TipoImpresora As Integer = 0
    ...
    Private Sub LlenaNodosImpresion()
        ...
        ImpND.Add(New NodoImpresionN("", "subtotal", Format(V.Subtotal - V.TotalIva + V.TotalISR + V.TotalIvaRetenida, O._formatoSubtotal).PadLeft(O.EspacioSubtotal), 0), "subtotal")
    ...
    '            YExtra = 0
    '            YExtra2 = 0
    '            If YCoord >= 156 And Posicion > 0 Then
    '                MasPaginas = True
    '                Exit While
    '            End If
    '            For Each n As NodoImpresionN In ImpNDi
    ...
    Private Sub Imprimir()
        ...
        PrintDocument1.DocumentName = "NCredito" + TextBox11.Text + TextBox2.Text
        Dim SA As New dbSucursalesArchivos
        Dim Impresora As String
        Impresora = SA.DaImpresoraActiva(IdsSucursales.Valor(ComboBox3.SelectedIndex), GlobalIdEmpresa, True, 0, TiposDocumentos.VentaNotadeCredito)
        TipoImpresora = SA.TipoImpresora
