Public Class frmNotasdeCargoConsulta
    ...
    Private Sub Consulta()
        Try
            If ConsultaOn Then
                ...
                Dim S As New dbNotasdeCargo(MySqlcon)
    ...
    Private Sub AbreDetalles()
        If IdVenta <> 0 Then
            If Modo = ModosDeBusqueda.Principal Then
                Dim F As New frmNotasdeCargo(DGServicios.Item(0, DGServicios.CurrentCell.RowIndex).Value)
                F.ShowDialog()
            Else
