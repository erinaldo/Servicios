Public Class frmDevolucionesConsulta
            ...
            If ConsultaOn Then
                ...
                Select Case ComboBox1.SelectedIndex
                    ...
                    Case 2
                        Credito = 0
                End Select
                Dim S As New dbDevoluciones(MySqlcon)
    ...
    Private Sub AbreDetalles()
        If IdVenta <> 0 Then
            If Modo = ModosDeBusqueda.Principal Then
                Dim F As New frmDevoluciones(DGServicios.Item(0, DGServicios.CurrentCell.RowIndex).Value, 0, 0, "", 0)
                F.ShowDialog()
            Else
