Public Class frmNotasDeCreditoConsulta
    ...
    Private Sub Consulta()
        Try
            If ConsultaOn Then
                ...
                Dim S As New dbNotasDeCredito(MySqlcon)
                ...
                DGServicios.Columns(4).HeaderText = "C. Cliente"
                DGServicios.Columns(5).HeaderText = "Cliente"
                DGServicios.Columns(6).HeaderText = "Total"
                DGServicios.Columns(7).HeaderText = "Aplicado"
                DGServicios.Columns(8).HeaderText = "Estado"
    ...
    Private Sub AbreDetalles()
        If IdVenta <> 0 Then
            If Modo = ModosDeBusqueda.Principal Then
                Dim F As New frmNotasdeCredito(DGServicios.Item(0, DGServicios.CurrentCell.RowIndex).Value)
                F.ShowDialog()
            Else
