        ...
        Try
            ...
            Select Case ListBox1.Text
                ...
                Case "Comparativo mensual facturas."
                    ...
                    rep.SetDataSource(ve.reporteComparativo(desde, hasta, ComboBox5.SelectedIndex, CheckBox14.Checked, True, IdsSucursales.Valor(ComboBox1.SelectedIndex), IdCliente, IdsTiposSuc.Valor(ComboBox15.SelectedIndex), IdsVendedores.Valor(ComboBox2.SelectedIndex)))
                ...
                Case "Comparativo mensual remisiones."
                    ...
                    desde = desde.Split("/")(0) + "/01/01"
                    Dim hasta As String = desde.Split("/")(0) + "/12/31"
                    rep.SetDataSource(r.reporteComparativo(desde, hasta, ComboBox5.SelectedIndex, CheckBox14.Checked, True, CheckBox6.Checked, IdsSucursales.Valor(ComboBox1.SelectedIndex), IdCliente, IdsTiposSuc.Valor(ComboBox15.SelectedIndex), IdsVendedores.Valor(ComboBox2.SelectedIndex)))
                    Dim Filtros As String
                    Filtros = "Período del: " + Format(DateTimePicker1.Value, "yyyy/MM/dd") + " al " + Format(DateTimePicker2.Value, "yyyy/MM/dd") + " Sucursal: " + ComboBox1.Text + vbCr
                    If IdCliente = 0 Then
                        Filtros += " Cliente: Todos"
                ...
                Case "Comparativo por ejercicio facturas."
                    ...
                    rep.SetDataSource(ve.comparativoMes(actual.ToString(), anterior.ToString(), ComboBox5.SelectedIndex, CheckBox14.Checked, True))
                    Dim filtros As String = ""
                ...
                Case "Comparativo por ejercicio remisiones."
                    ...
                    Dim r As New dbVentasRemisiones(MySqlcon)
                    've.comparativoMes(actual.ToString(), anterior.ToString())
                    rep.SetDataSource(r.comparativoMes(actual.ToString(), anterior.ToString(), ComboBox5.SelectedIndex, CheckBox14.Checked, True, CheckBox6.Checked))
                    Dim filtros As String = ""
                    filtros = "Sucursal: " + ComboBox1.Text
                    If ComboBox5.SelectedIndex > 0 Then
                        filtros += " Mostrado en: " + ComboBox5.Text
                ...
                Case "Ventas clientes concentrado."
                    ...
                    idTipo = IdsTipos.Valor(comboTipo.SelectedIndex)
                    Rep.SetDataSource(V.Reporte(Format(DateTimePicker1.Value, "yyyy/MM/dd"), Format(DateTimePicker2.Value, "yyyy/MM/dd"), IdsSucursales.Valor(ComboBox1.SelectedIndex), IdCliente, IdsVendedores.Valor(ComboBox2.SelectedIndex), IdsMonedas.Valor(ComboBox4.SelectedIndex), ComboBox5.SelectedIndex, IdInventario, idClas, idClas2, idClas3, CheckBox14.Checked, TextBox5.Text, idClas4, idClas5, False, IdsAlmacenes.Valor(ComboBox13.SelectedIndex), idTipo, True, IdsTiposSuc.Valor(ComboBox15.SelectedIndex), False))
                    Dim s1 As New dbSucursales(GlobalIdSucursalDefault, MySqlcon)
                    Rep.SetParameterValue("Encabezado", S.NombreFiscal)
                    Dim Filtros As String
                ...
                Case "Ventas tipo B."
                    ...
                    idTipo = IdsTipos.Valor(comboTipo.SelectedIndex)
                    Rep.SetDataSource(V.ReporteVentasArticulos(Format(DateTimePicker1.Value, "yyyy/MM/dd"), Format(DateTimePicker2.Value, "yyyy/MM/dd"), IdsSucursales.Valor(ComboBox1.SelectedIndex), IdCliente, IdInventario, idClas, idClas2, idClas3, IdsVendedores.Valor(ComboBox2.SelectedIndex), IdsMonedas.Valor(ComboBox4.SelectedIndex), ComboBox5.SelectedIndex, False, TextBox5.Text, False, idClas4, idClas5, CheckBox14.Checked, False, IdsAlmacenes.Valor(ComboBox13.SelectedIndex), CheckBox10.Checked, idTipo, IdsTiposSuc.Valor(ComboBox15.SelectedIndex), False))
                    Rep.SetParameterValue("Encabezado", S.NombreFiscal)
                    Dim Filtros As String
                ...
                Case "Remisiones tipo B."
                    ...
                    Rep = New repVentasIvasB
                    idTipo = IdsTipos.Valor(comboTipo.SelectedIndex)
                    Rep.SetDataSource(R.ReporteVentastipoB(Format(DateTimePicker1.Value, "yyyy/MM/dd"), Format(DateTimePicker2.Value, "yyyy/MM/dd"), IdsSucursales.Valor(ComboBox1.SelectedIndex), IdCliente, IdInventario, idClas, idClas2, idClas3, IdsVendedores.Valor(ComboBox2.SelectedIndex), IdsMonedas.Valor(ComboBox4.SelectedIndex), ComboBox5.SelectedIndex, False, TextBox5.Text, False, idClas4, CheckBox14.Checked, Oc.OcultarOc, Oc.SeriesOc, IdsAlmacenes.Valor(ComboBox13.SelectedIndex), IdsCajas.Valor(ComboBox14.SelectedIndex), idTipo, IdsTiposSuc.Valor(ComboBox15.SelectedIndex)))
                    Rep.SetParameterValue("Encabezado", S.NombreFiscal)
                    Dim Filtros As String
                ...
                Case "Remisiones por tasa de IEPS."
                    ...
                    idTipo = IdsTipos.Valor(comboTipo.SelectedIndex)
                    Rep.SetDataSource(VR.ReporteVentasArticulos(Format(DateTimePicker1.Value, "yyyy/MM/dd"), Format(DateTimePicker2.Value, "yyyy/MM/dd"), IdsSucursales.Valor(ComboBox1.SelectedIndex), IdCliente, IdInventario, idClas, idClas2, idClas3, IdsVendedores.Valor(ComboBox2.SelectedIndex), IdsMonedas.Valor(ComboBox4.SelectedIndex), ComboBox5.SelectedIndex, CheckBox6.Checked, False, Oc.SeriesOc, Oc.OcultarOc, TextBox5.Text, False, idClas4, idClas5, IdsAlmacenes.Valor(ComboBox13.SelectedIndex), IdsCajas.Valor(ComboBox14.SelectedIndex), idTipo, IdsTiposSuc.Valor(ComboBox15.SelectedIndex), True))
                    Rep.SetParameterValue("Encabezado", S.NombreFiscal)
                    Dim Filtros As String
                    Filtros = "Período del: " + Format(DateTimePicker1.Value, "yyyy/MM/dd") + " al " + Format(DateTimePicker2.Value, "yyyy/MM/dd") + " Sucursal: " + ComboBox1.Text + vbCr
                    If IdCliente = 0 Then
                    ...
                    'Dim R As New dbVentasRemisiones(MySqlcon)
                    'Rep = New repVentasIEPS
                    'Rep.SetDataSource(R.ReporteIEPSRemisiones(Format(DateTimePicker1.Value, "yyyy/MM/dd"), Format(DateTimePicker2.Value, "yyyy/MM/dd"), IdsSucursales.Valor(ComboBox1.SelectedIndex), IdCliente, IdsVendedores.Valor(ComboBox2.SelectedIndex), IdsMonedas.Valor(ComboBox4.SelectedIndex), ComboBox5.SelectedIndex, IdInventario, idClas, idClas2, idClas3, CheckBox14.Checked, TextBox5.Text, idClas4, idClas5, False, IdsAlmacenes.Valor(ComboBox13.SelectedIndex), idTipo, False, IdsTiposSuc.Valor(ComboBox15.SelectedIndex), True))
                    'Rep.SetParameterValue("Encabezado", S.NombreFiscal)
                    'Dim Filtros As String
                    'Filtros = "Fechas: " + Format(DateTimePicker1.Value, "yyyy/MM/dd") + " al " + Format(DateTimePicker2.Value, "yyyy/MM/dd") + " Sucursal: " + ComboBox1.Text + " Almacen: " + ComboBox13.Text + vbCr
                    'If IdCliente = 0 Then
                    ...
                    'Rep.SetParameterValue("Filtros", Filtros)
                    'Rep.SetParameterValue("sucursal", ComboBox1.Text)
                    'Rep.SetParameterValue("subtitulo", "Reporte de remisiones por tasa de IEPS")
                    'Dim RV As New frmReportes(Rep, False)
                    'RV.Show()
                ...
                Case "Ventas por método de pago B."
                    ...
                    Rep.Subreports.Item(0).SetDataSource(V.ReportePorTipodePagoN(Format(DateTimePicker1.Value, "yyyy/MM/dd"), Format(DateTimePicker2.Value, "yyyy/MM/dd"), IdsSucursales.Valor(ComboBox1.SelectedIndex), IdCliente, IdsVendedores.Valor(ComboBox2.SelectedIndex), IdsMonedas.Valor(ComboBox4.SelectedIndex), ComboBox5.SelectedIndex, TextBox5.Text, IdsFormas.Valor(ComboBox12.SelectedIndex), idClas4, idClas5, CheckBox14.Checked, IdsAlmacenes.Valor(ComboBox13.SelectedIndex), idTipo, 0, 0, 0, 0, False, True, True, IdsTiposSuc.Valor(ComboBox15.SelectedIndex)))
                    Rep.SetParameterValue("Encabezado", S.NombreFiscal)
                    Dim Filtros As String
                    Filtros = "Fechas: " + Format(DateTimePicker1.Value, "yyyy/MM/dd") + " al " + Format(DateTimePicker2.Value, "yyyy/MM/dd") + " Sucursal: " + ComboBox1.Text + "  Método de pago: " + ComboBox12.Text + vbCr
                    If IdCliente = 0 Then
                ...
                Case "Ventas por artículo."
                    ...
                    End If
                    idTipo = IdsTipos.Valor(comboTipo.SelectedIndex)
                    Rep.SetDataSource(V.ReporteVentasArticulos(Format(DateTimePicker1.Value, "yyyy/MM/dd"), Format(DateTimePicker2.Value, "yyyy/MM/dd"), IdsSucursales.Valor(ComboBox1.SelectedIndex), IdCliente, IdInventario, idClas, idClas2, idClas3, IdsVendedores.Valor(ComboBox2.SelectedIndex), IdsMonedas.Valor(ComboBox4.SelectedIndex), ComboBox5.SelectedIndex, False, TextBox5.Text, False, idClas4, idClas5, CheckBox14.Checked, True, IdsAlmacenes.Valor(ComboBox13.SelectedIndex), CheckBox10.Checked, idTipo, IdsTiposSuc.Valor(ComboBox15.SelectedIndex), False))
                    Rep.SetParameterValue("Encabezado", S.NombreFiscal)
                    Dim Filtros As String
                    Filtros = "Fechas: " + Format(DateTimePicker1.Value, "yyyy/MM/dd") + " al " + Format(DateTimePicker2.Value, "yyyy/MM/dd") + " Sucursal: " + ComboBox1.Text + " Almacen: " + ComboBox13.Text + vbCr
                    If IdCliente = 0 Then
                ...
                Case "Remisiones clientes concentrado."
                    ...
                    idTipo = IdsTipos.Valor(comboTipo.SelectedIndex)
                    Rep.SetDataSource(VR.Reporte(Format(DateTimePicker1.Value, "yyyy/MM/dd"), Format(DateTimePicker2.Value, "yyyy/MM/dd"), IdsSucursales.Valor(ComboBox1.SelectedIndex), IdCliente, ComboBox5.SelectedIndex, CheckBox14.Checked, CheckBox6.Checked, IdsVendedores.Valor(ComboBox2.SelectedIndex), Oc.SeriesOc, Oc.OcultarOc, TextBox5.Text, idClas4, idClas5, False, IdsCajas.Valor(ComboBox14.SelectedIndex), idTipo, True, IdsTiposSuc.Valor(ComboBox15.SelectedIndex)))
                    Rep.SetParameterValue("Encabezado", S.NombreFiscal)
                    Rep.SetParameterValue("TipoRep", "Reporte de Remisiones")
                    Dim Filtros As String
                    Filtros = "Período del: " + Format(DateTimePicker1.Value, "yyyy/MM/dd") + " al " + Format(DateTimePicker2.Value, "yyyy/MM/dd") + " Sucursal: " + ComboBox1.Text + vbCr
                ...
                Case "Remisiones por artículo."
                    ...
                    idTipo = IdsTipos.Valor(comboTipo.SelectedIndex)
                    Rep.SetDataSource(VR.ReporteVentasArticulos(Format(DateTimePicker1.Value, "yyyy/MM/dd"), Format(DateTimePicker2.Value, "yyyy/MM/dd"), IdsSucursales.Valor(ComboBox1.SelectedIndex), IdCliente, IdInventario, idClas, idClas2, idClas3, IdsVendedores.Valor(ComboBox2.SelectedIndex), IdsMonedas.Valor(ComboBox4.SelectedIndex), ComboBox5.SelectedIndex, CheckBox6.Checked, False, Oc.SeriesOc, Oc.OcultarOc, TextBox5.Text, False, idClas4, idClas5, IdsAlmacenes.Valor(ComboBox13.SelectedIndex), IdsCajas.Valor(ComboBox14.SelectedIndex), idTipo, IdsTiposSuc.Valor(ComboBox15.SelectedIndex), False))
                    Rep.SetParameterValue("Encabezado", S.NombreFiscal)
                    Dim Filtros As String
                    Filtros = "Período del: " + Format(DateTimePicker1.Value, "yyyy/MM/dd") + " al " + Format(DateTimePicker2.Value, "yyyy/MM/dd") + " Sucursal: " + ComboBox1.Text + vbCr
                    If IdCliente = 0 Then
                ...
                Case "Remisiones por artículo concentrado."
                    ...
                    idTipo = IdsTipos.Valor(comboTipo.SelectedIndex)
                    Rep.SetDataSource(VR.ReporteVentasArticulos(Format(DateTimePicker1.Value, "yyyy/MM/dd"), Format(DateTimePicker2.Value, "yyyy/MM/dd"), IdsSucursales.Valor(ComboBox1.SelectedIndex), IdCliente, IdInventario, idClas, idClas2, idClas3, IdsVendedores.Valor(ComboBox2.SelectedIndex), IdsMonedas.Valor(ComboBox4.SelectedIndex), ComboBox5.SelectedIndex, CheckBox6.Checked, True, Oc.SeriesOc, Oc.OcultarOc, TextBox5.Text, False, idClas4, idClas5, IdsAlmacenes.Valor(ComboBox13.SelectedIndex), IdsCajas.Valor(ComboBox14.SelectedIndex), idTipo, IdsTiposSuc.Valor(ComboBox15.SelectedIndex), False))
                    Rep.SetParameterValue("Encabezado", S.NombreFiscal)
                    Dim Filtros As String
                    Filtros = "Período del: " + Format(DateTimePicker1.Value, "yyyy/MM/dd") + " al " + Format(DateTimePicker2.Value, "yyyy/MM/dd") + " Sucursal: " + ComboBox1.Text + vbCr
                    If IdCliente = 0 Then
                ...
                Case "Remisiones por artículo concentrado por vendedor."
                    ...
                    idTipo = IdsTipos.Valor(comboTipo.SelectedIndex)
                    Rep.SetDataSource(VR.ReporteVentasArticulos(Format(DateTimePicker1.Value, "yyyy/MM/dd"), Format(DateTimePicker2.Value, "yyyy/MM/dd"), IdsSucursales.Valor(ComboBox1.SelectedIndex), IdCliente, IdInventario, idClas, idClas2, idClas3, IdsVendedores.Valor(ComboBox2.SelectedIndex), IdsMonedas.Valor(ComboBox4.SelectedIndex), ComboBox5.SelectedIndex, CheckBox6.Checked, True, Oc.SeriesOc, Oc.OcultarOc, TextBox5.Text, True, idClas4, idClas5, IdsAlmacenes.Valor(ComboBox13.SelectedIndex), IdsCajas.Valor(ComboBox14.SelectedIndex), idTipo, IdsTiposSuc.Valor(ComboBox15.SelectedIndex), False))
                    Rep.SetParameterValue("Encabezado", S.NombreFiscal)
                    Rep.SetParameterValue("conDetalle", checkLinea.Checked)
                    Dim Filtros As String
                    Filtros = "Período del: " + Format(DateTimePicker1.Value, "yyyy/MM/dd") + " al " + Format(DateTimePicker2.Value, "yyyy/MM/dd") + " Sucursal: " + ComboBox1.Text + vbCr
