Public Class frmServiciosSuc
    ...
    Private Sub frmServiciosSuc_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.Icon = GlobalIcono
    ...
    End Sub
    Private Sub ConsultaSucursal()
        Try
            If ConsultaOn Then
                Dim C As New dbSucursales(MySqlcon)
                DGC.DataSource = C.Consulta(TextBox1.Text)
                DGC.Columns(0).Visible = False
                DGC.Columns(1).HeaderText = "Clave"
    ...
    Private Sub DGC_CellClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DGC.CellClick
    ...
    Private Sub LlenaDatosClientes()
        Try
            ...
            Dim C As New dbSucursales(idCliente, MySqlcon)
    ...
    Private Sub LlenaDatosClientesEquipo(ByVal pidEquipo As Integer)
        Try
            IdEquipo = pidEquipo
            Dim C As New dbClientesEquipos(IdEquipo, MySqlcon, 1)
    ...
    Private Sub ConsultaEquipos()
        Try
            ...
            If ConsultaOn Then
                ...
                DataGridView1.DataSource = P.ConsultaSuc(idCliente, TextBox2.Text)
    ...
    Private Sub Button5_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button5.Click
        Dim f As New frmClientesEquipos(idCliente, 1, 2)
        f.ShowDialog()
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Try
            If GlobalPermisos.ChecaPermiso(PermisosN.Servicios.ServicioGuardar, PermisosN.Secciones.Servicios) = True Then
                ...
                S.GuardarSucursal(TextBox3.Text, Format(DateTimePicker1.Value, "yyyy/MM/dd"), Format(Date.Now, "HH:mm"), Format(DateTimePicker1.Value, "yyyy/MM/dd"), Format(Date.Now, "HH:mm"), 0, idCliente, 0, S.DaNuevoFolioSucursal, IdEquipo, IdsTecnicos.Valor(ComboBox3.SelectedIndex))
                If IdEquipo > 0 Then
                    Dim SE As New dbServiciosEquipos(MySqlcon)
                    SE.GuardarSucursal(S.ID, IdEquipo, idCliente)
                    ' IMPRIMIR()
    ...
    Public Sub IMPRIMIR()
        ...
        Rep.SetParameterValue("tipo", "DATOS DE LA SUCURSAL")
