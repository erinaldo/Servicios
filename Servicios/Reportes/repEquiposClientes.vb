...
Public Class repEquiposClientes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repEquiposClientes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepEquiposClientes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repEquiposClientes = New repEquiposClientes()
        rpt.Site = Me.Site
        Return rpt
    End Function
