...
Public Class repContabilidadCat
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repContabilidadCat.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepContabilidadCat
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repContabilidadCat = New repContabilidadCat()
        rpt.Site = Me.Site
        Return rpt
    End Function
