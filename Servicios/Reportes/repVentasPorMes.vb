...
Public Class repVentasPorMes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repVentasPorMes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepVentasPorMes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repVentasPorMes = New repVentasPorMes()
        rpt.Site = Me.Site
        Return rpt
    End Function
