...
Public Class repComprasPagos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repComprasPagos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepComprasPagos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repComprasPagos = New repComprasPagos()
        rpt.Site = Me.Site
        Return rpt
    End Function
