...
Public Class repVentasAduanas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repVentasAduanas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepVentasAduanas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repVentasAduanas = New repVentasAduanas()
        rpt.Site = Me.Site
        Return rpt
    End Function
