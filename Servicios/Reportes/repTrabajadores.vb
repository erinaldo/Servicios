...
Public Class repTrabajadores
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repTrabajadores.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepTrabajadores
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repTrabajadores = New repTrabajadores()
        rpt.Site = Me.Site
        Return rpt
    End Function
