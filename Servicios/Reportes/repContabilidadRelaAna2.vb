...
Public Class repContabilidadRelaAna2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "repContabilidadRelaAna2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repContabilidadRelaAna2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_congrupos() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrepContabilidadRelaAna2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repContabilidadRelaAna2 = New repContabilidadRelaAna2()
        rpt.Site = Me.Site
        Return rpt
    End Function
