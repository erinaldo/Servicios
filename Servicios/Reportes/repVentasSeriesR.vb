...
Public Class repVentasSeriesR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repVentasSeriesR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepVentasSeriesR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repVentasSeriesR = New repVentasSeriesR()
        rpt.Site = Me.Site
        Return rpt
    End Function
