...
Public Class rptConciliacion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.rptConciliacion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptConciliacion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptConciliacion = New rptConciliacion()
        rpt.Site = Me.Site
        Return rpt
    End Function
