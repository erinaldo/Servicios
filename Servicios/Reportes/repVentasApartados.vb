...
Public Class repVentasApartados
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repVentasApartados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepVentasApartados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repVentasApartados = New repVentasApartados()
        rpt.Site = Me.Site
        Return rpt
    End Function
