...
Public Class repVentasCorte
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repVentasCorte.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_todo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrepVentasCorte
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repVentasCorte = New repVentasCorte()
        rpt.Site = Me.Site
        Return rpt
    End Function
