...
Public Class repVentasSeriesc
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repVentasSeriesc.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepVentasSeriesc
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repVentasSeriesc = New repVentasSeriesc()
        rpt.Site = Me.Site
        Return rpt
    End Function
