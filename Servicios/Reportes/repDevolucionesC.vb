...
Public Class repDevolucionesC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repDevolucionesC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepDevolucionesC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repDevolucionesC = New repDevolucionesC()
        rpt.Site = Me.Site
        Return rpt
    End Function
