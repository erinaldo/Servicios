...
Public Class repVentaslosmas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repVentaslosmas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepVentaslosmas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repVentaslosmas = New repVentaslosmas()
        rpt.Site = Me.Site
        Return rpt
    End Function
