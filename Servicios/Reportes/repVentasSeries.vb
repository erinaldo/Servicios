...
Public Class repVentasSeries
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repVentasSeries.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepVentasSeries
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repVentasSeries = New repVentasSeries()
        rpt.Site = Me.Site
        Return rpt
    End Function
