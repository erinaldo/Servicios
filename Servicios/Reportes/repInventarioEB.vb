...
Public Class repInventarioEB
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repInventarioEB.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_quitarceros() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrepInventarioEB
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repInventarioEB = New repInventarioEB()
        rpt.Site = Me.Site
        Return rpt
    End Function
