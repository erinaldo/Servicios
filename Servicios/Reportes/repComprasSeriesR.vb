...
Public Class repComprasSeriesR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repComprasSeriesR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepComprasSeriesR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repComprasSeriesR = New repComprasSeriesR()
        rpt.Site = Me.Site
        Return rpt
    End Function
