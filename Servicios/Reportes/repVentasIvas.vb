...
Public Class repVentasIvas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repVentasIvas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepVentasIvas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repVentasIvas = New repVentasIvas()
        rpt.Site = Me.Site
        Return rpt
    End Function
