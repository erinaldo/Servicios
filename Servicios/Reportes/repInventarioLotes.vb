...
Public Class repInventarioLotes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repInventarioLotes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepInventarioLotes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repInventarioLotes = New repInventarioLotes()
        rpt.Site = Me.Site
        Return rpt
    End Function
