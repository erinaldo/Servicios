...
Public Class repInventarioEE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repInventarioEE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepInventarioEE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repInventarioEE = New repInventarioEE()
        rpt.Site = Me.Site
        Return rpt
    End Function
