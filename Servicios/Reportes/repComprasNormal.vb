...
Public Class repComprasNormal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repComprasNormal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepComprasNormal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repComprasNormal = New repComprasNormal()
        rpt.Site = Me.Site
        Return rpt
    End Function
