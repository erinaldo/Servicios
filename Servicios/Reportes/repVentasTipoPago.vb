...
Public Class repVentasTipoPago
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repVentasTipoPago.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepVentasTipoPago
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repVentasTipoPago = New repVentasTipoPago()
        rpt.Site = Me.Site
        Return rpt
    End Function
