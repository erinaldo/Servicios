...
Public Class repComprasLotes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repComprasLotes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepComprasLotes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repComprasLotes = New repComprasLotes()
        rpt.Site = Me.Site
        Return rpt
    End Function
