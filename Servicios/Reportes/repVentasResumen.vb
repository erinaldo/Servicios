...
Public Class repVentasResumen
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repVentasResumen.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepVentasResumen
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repVentasResumen = New repVentasResumen()
        rpt.Site = Me.Site
        Return rpt
    End Function
