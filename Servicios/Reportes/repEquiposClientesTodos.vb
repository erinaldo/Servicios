...
Public Class repEquiposClientesTodos
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "repEquiposClientesTodos.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repEquiposClientesTodos.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_DATO() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrepEquiposClientesTodos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repEquiposClientesTodos = New repEquiposClientesTodos()
        rpt.Site = Me.Site
        Return rpt
    End Function
