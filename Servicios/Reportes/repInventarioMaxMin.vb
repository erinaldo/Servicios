...
Public Class repInventarioMaxMin
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "repInventarioMaxMin.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repInventarioMaxMin.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Menoscero() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrepInventarioMaxMin
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repInventarioMaxMin = New repInventarioMaxMin()
        rpt.Site = Me.Site
        Return rpt
    End Function
