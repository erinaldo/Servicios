...
Public Class repVentasTipoPagoB
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repVentasTipoPagoB.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepVentasTipoPagoB
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repVentasTipoPagoB = New repVentasTipoPagoB()
        rpt.Site = Me.Site
        Return rpt
    End Function
