...
Public Class repComprasSeries
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repComprasSeries.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepComprasSeries
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repComprasSeries = New repComprasSeries()
        rpt.Site = Me.Site
        Return rpt
    End Function
