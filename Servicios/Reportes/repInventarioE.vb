...
Public Class repInventarioE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repInventarioE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepInventarioE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repInventarioE = New repInventarioE()
        rpt.Site = Me.Site
        Return rpt
    End Function
