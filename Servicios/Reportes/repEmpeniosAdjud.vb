...
Public Class repEmpeniosAdjud
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repEmpeniosAdjud.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepEmpeniosAdjud
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repEmpeniosAdjud = New repEmpeniosAdjud()
        rpt.Site = Me.Site
        Return rpt
    End Function
