...
Public Class repVentasVendedor
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repVentasVendedor.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_condetalles() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrepVentasVendedor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repVentasVendedor = New repVentasVendedor()
        rpt.Site = Me.Site
        Return rpt
    End Function
