...
Public Class repVentasIEPS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repVentasIEPS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepVentasIEPS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repVentasIEPS = New repVentasIEPS()
        rpt.Site = Me.Site
        Return rpt
    End Function
