...
Public Class repClientesAna
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repClientesAna.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_titulo01() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrepClientesAna
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repClientesAna = New repClientesAna()
        rpt.Site = Me.Site
        Return rpt
    End Function
