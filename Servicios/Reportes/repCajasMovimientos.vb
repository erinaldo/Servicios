...
Public Class repCajasMovimientos
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "repCajasMovimientos.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repCajasMovimientos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepCajasMovimientos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repCajasMovimientos = New repCajasMovimientos()
        rpt.Site = Me.Site
        Return rpt
    End Function
