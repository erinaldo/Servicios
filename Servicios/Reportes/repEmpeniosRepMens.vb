...
Public Class repEmpeniosRepMens
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repEmpeniosRepMens.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepEmpeniosRepMens
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repEmpeniosRepMens = New repEmpeniosRepMens()
        rpt.Site = Me.Site
        Return rpt
    End Function
