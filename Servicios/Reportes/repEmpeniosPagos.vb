...
Public Class repEmpeniosPagos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repEmpeniosPagos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepEmpeniosPagos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repEmpeniosPagos = New repEmpeniosPagos()
        rpt.Site = Me.Site
        Return rpt
    End Function
