...
Public Class repEmpeniosEstatus
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repEmpeniosEstatus.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepEmpeniosEstatus
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repEmpeniosEstatus = New repEmpeniosEstatus()
        rpt.Site = Me.Site
        Return rpt
    End Function
