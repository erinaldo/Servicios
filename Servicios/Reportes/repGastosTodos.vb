...
Public Class repGastosTodos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repGastosTodos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepGastosTodos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repGastosTodos = New repGastosTodos()
        rpt.Site = Me.Site
        Return rpt
    End Function
