...
Public Class repAlmacenesEstado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repAlmacenesEstado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepAlmacenesEstado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repAlmacenesEstado = New repAlmacenesEstado()
        rpt.Site = Me.Site
        Return rpt
    End Function
