...
Public Class repVentasPagos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repVentasPagos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepVentasPagos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repVentasPagos = New repVentasPagos()
        rpt.Site = Me.Site
        Return rpt
    End Function
