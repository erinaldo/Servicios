...
Public Class repGastosDetalles
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repGastosDetalles.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepGastosDetalles
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repGastosDetalles = New repGastosDetalles()
        rpt.Site = Me.Site
        Return rpt
    End Function
