...
Public Class repMovimientos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repMovimientos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepMovimientos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repMovimientos = New repMovimientos()
        rpt.Site = Me.Site
        Return rpt
    End Function
