...
Public Class repCartaSalida
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Servicios.repCartaSalida.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepCartaSalida
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repCartaSalida = New repCartaSalida()
        rpt.Site = Me.Site
        Return rpt
    End Function
